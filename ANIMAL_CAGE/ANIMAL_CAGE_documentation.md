# ANIMAL_CAGE Schema Documentation
...
| `target_species[item].language_tag` | Required in target_species[item] object |
| `target_species[item].value` | Required in target_species[item] object |
...
- `target_species.value` - Required when `target_species` is provided
- `target_species.language_tag` - Required when `target_species` is provided
...
| `team_name` | array | Provide the name of the sports team associated with the animal cage, indicating any team-specific branding or design elements. |
...
| `target_species` | array | This attribute identifies the species of animal the item is to be used for. |
| `number_of_levels` | array | Provide the number of separate floors or tiers the item has, indicating its vertical capacity for housing animals. |
...
| `pet_type` | array | Provide the broad classification of pet the cage is designed for, based on species or groups with similar habitat and care needs. |
...
Provide the name of the sports team associated with the animal cage, indicating any team-specific branding or design elements.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the animal cage, indicating any team-specific branding or design elements. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
This attribute identifies the species of animal the item is to be used for.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | This attribute identifies the species of animal the item is to be used for. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### number_of_levels

Provide the number of separate floors or tiers the item has, indicating its vertical capacity for housing animals.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of distinct floors or platforms within the cage, indicating the vertical living space available for the animal. |
| `marketplace_id` | object | No |  |
...
Provide the broad classification of pet the cage is designed for, based on species or groups with similar habitat and care needs.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the broad classification of pet the cage is designed for, based on species or groups with similar habitat and care needs. |
| `marketplace_id` | object | No |  |
