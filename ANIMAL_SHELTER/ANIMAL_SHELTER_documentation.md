# ANIMAL_SHELTER Schema Documentation
...
| `style` | array | Provide the aesthetic design of the animal shelter, describing its distinctive visual appearance and representation. |
...
| `item_depth_width_height` | array | Provide the length, width, and height of the item when fully set up, ready for an animal to enter and use. |
...
| `pet_type` | array | Provide the broad classification of pet the shelter is designed for, such as the species or group with similar habitat and care needs. |
...
Provide the aesthetic design of the animal shelter, describing its distinctive visual appearance and representation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the aesthetic design of the animal shelter, describing its distinctive visual appearance and representation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the length, width, and height of the item when fully set up, ready for an animal to enter and use.
...
Provide the broad classification of pet the shelter is designed for, such as the species or group with similar habitat and care needs.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the broad classification of pet the shelter is designed for, such as the species or group with similar habitat and care needs. |
| `marketplace_id` | object | No |  |
