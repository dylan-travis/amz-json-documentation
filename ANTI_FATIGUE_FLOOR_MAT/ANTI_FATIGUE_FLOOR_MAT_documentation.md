...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials specifically excluded from the floor mat, indicating substances not used in its construction or content. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the floor mat, indicating the team branding or design featured on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the item length. |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the item thickness. |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the item width. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `string_value` | string | No | Provide the  item width in string value |
| `unit` | string | Yes | Select the corresponding unit |
