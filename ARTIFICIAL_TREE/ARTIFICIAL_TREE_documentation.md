# ARTIFICIAL_TREE Schema Documentation
...
| `container[item].type[item].language_tag` | Required in container[item].type[item] object |
| `container[item].type[item].language_tag` | Required in container[item].type[item] object |
| `container[item].type[item].value` | Required in container[item].type[item] object |
| `container[item].type[item].value` | Required in container[item].type[item] object |
...
| `has_builtin_light[item].value` | Required in has_builtin_light[item] object |
...
| `number_of_hooks[item].value` | Required in number_of_hooks[item] object |
...
| `number_of_packs[item].value` | Required in number_of_packs[item] object |
...
| `plant_or_animal_product_type[item].value` | Required in plant_or_animal_product_type[item] object |
...
| `seasons[item].language_tag` | Required in seasons[item] object |
| `seasons[item].value` | Required in seasons[item] object |
...
- `plant_or_animal_product_type.value` - Required when `plant_or_animal_product_type` is provided
...
- `has_builtin_light.value` - Required when `has_builtin_light` is provided
...
- `number_of_hooks.value` - Required when `number_of_hooks` is provided
...
- `seasons.value` - Required when `seasons` is provided
- `seasons.language_tag` - Required when `seasons` is provided
...
| `plant_or_animal_product_type` | array | Provide the type of plant or animal product the artificial tree is designed to mimic or represent, if applicable. |
...
| `special_feature` | array | Provide the unique characteristics that set this artificial tree apart from similar products, enhancing its appeal or functionality. |
...
| `occasion_type` | array | Provide the occasion or event the item is designed for, such as holidays, seasons, or special occasions. |
...
| `has_builtin_light` | array | Provide if the item has an integrated light |
...
| `number_of_hooks` | array | Provide the number of hooks the item has |
...
| `team_name` | array | Provide the sports team name associated with the artificial tree, indicating the team-themed design or branding of the product. |
...
| `container` | array | The attribute indicates Container of the product |
| `length_range` | array | Length range for blinds |
| `width_range` | array | Width range for blinds |
| `seasons` | array | Specify the season(s) most appropriate for the item |
| `item_depth_width_height` | array | Provide the dimensions of the item when fully set up, the length, width, and height it occupies when ready for use. |
...
Provide the type of plant or animal product the artificial tree is designed to mimic or represent, if applicable.

**Type:** array

**Title:** Plant or Animal Product Type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of plant or animal product the artificial tree is designed to mimic or represent, if applicable. |
| `marketplace_id` | object | No |  |
...
Provide the unique characteristics that set this artificial tree apart from similar products, enhancing its appeal or functionality.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this artificial tree apart from similar products, enhancing its appeal or functionality. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the occasion or event the item is designed for, such as holidays, seasons, or special occasions.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event that the artificial tree is designed for, such as specific celebrations or commemorations. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide if the item has an integrated light
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide if the item has an integrated light |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the number of hooks the item has |
| `marketplace_id` | object | No |  |
...
Provide the sports team name associated with the artificial tree, indicating the team-themed design or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the sports team name associated with the artificial tree, indicating the team-themed design or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Container of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Provide the type of container used to enclose the item or the contents of the item. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the season(s) most appropriate for the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### item_depth_width_height

Provide the dimensions of the item when fully set up, the length, width, and height it occupies when ready for use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back when assembled and placed in the manner in which it is expected to be used. Include the plant and container. |
| `height` | object | Yes | Provide the height from the base of pot to top of the tree when assembled and placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side when assembled and placed in the manner in which it is expected to be used. Include the plant and container. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back when assembled and placed in the manner in which it is expected to be used. Include the plant and container.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back when assembled and placed in the manner in which it is expected to be used. Include the plant and container. |
| `unit` | string | Yes | Select the unit of measure for the item depth. |

#### item_depth_width_height[].height

Provide the height from the base of pot to top of the tree when assembled and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height from the base of pot to top of the tree when assembled and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Select the unit of measure for the item height. |

#### item_depth_width_height[].width

Provide the width of the item from side to side when assembled and placed in the manner in which it is expected to be used. Include the plant and container.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item from side to side when assembled and placed in the manner in which it is expected to be used. Include the plant and container. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the count of inner packs included in an item. For a single pack or packed assortment of non-identical items, enter 1. |
| `marketplace_id` | object | No |  |
