# ART_EASEL Schema Documentation
...
| `easel_type[item].value` | Required in easel_type[item] object |
...
| `maximum_size[item].language_tag` | Required in maximum_size[item] object |
| `maximum_size[item].value` | Required in maximum_size[item] object |
...
- `maximum_size.value` - Required when `maximum_size` is provided
- `maximum_size.language_tag` - Required when `maximum_size` is provided
...
- `easel_type.value` - Required when `easel_type` is provided
...
| `maximum_size` | array | Indicate the maximum size of the product |
...
| `easel_type` | array | Provide the specific design and functionality of the art easel, indicating its shape, intended use, and primary features. |
...
Indicate the maximum size of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Indicate the maximum size of the product |
| `unit` | string | No | Indicate the unit of the maximum size of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back when fully unfolded. |
| `height` | object | Yes | Provide the height of the item from base to top when fully unfolded. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side when fully unfolded. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back when fully unfolded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back when fully unfolded. |
| `unit` | string | Yes | Select the unit of measure for the item depth. |

#### item_depth_width_height[].height

Provide the height of the item from base to top when fully unfolded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from base to top when fully unfolded. |
| `unit` | string | Yes | Select the unit of measure for the item height. |

#### item_depth_width_height[].width

Provide the width of the item from side to side when fully unfolded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item from side to side when fully unfolded. |
| `unit` | string | Yes | Select the unit of measure for the item width. |

### easel_type

Provide the specific design and functionality of the art easel, indicating its shape, intended use, and primary features.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific design and functionality of the art easel, indicating its shape, intended use, and primary features. |
| `marketplace_id` | object | No |  |
