...
| `easel_type` | array | Provide the specific type of easel. Easel types are primarily defined by their design, shape, functionality, and intended use. |
...
Provide the specific type of easel. Easel types are primarily defined by their design, shape, functionality, and intended use.
