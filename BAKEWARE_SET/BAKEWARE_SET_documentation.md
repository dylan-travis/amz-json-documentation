# BAKEWARE_SET Schema Documentation
...
| `material_type_free` | array | Provide the materials or types of materials that are specifically excluded from the item. |
...
Provide the materials or types of materials that are specifically excluded from the item.
