# BAKING_PAN Schema Documentation
...
| `deprecated_shaft_style_type[item].language_tag` | Required in deprecated_shaft_style_type[item] object |
| `deprecated_shaft_style_type[item].value` | Required in deprecated_shaft_style_type[item] object |
...
| `hard_disk[item].size[item].value` | Required in hard_disk[item].size[item] object |
| `hard_disk[item].size[item].value` | Required in hard_disk[item].size[item] object |
...
| `item_length_description[item].language_tag` | Required in item_length_description[item] object |
| `item_length_description[item].value` | Required in item_length_description[item] object |
...
| `rim[item].size[item].unit` | Required in rim[item].size[item] object |
| `rim[item].size[item].unit` | Required in rim[item].size[item] object |
| `rim[item].size[item].value` | Required in rim[item].size[item] object |
| `rim[item].size[item].value` | Required in rim[item].size[item] object |
...
| `waist[item].style[item].language_tag` | Required in waist[item].style[item] object |
| `waist[item].style[item].language_tag` | Required in waist[item].style[item] object |
| `waist[item].style[item].value` | Required in waist[item].style[item] object |
| `waist[item].style[item].value` | Required in waist[item].style[item] object |
...
- `item_length_description.value` - Required when `item_length_description` is provided
- `item_length_description.language_tag` - Required when `item_length_description` is provided
...
| `rim` | array | The attribute indicates Rim of the product |
| `item_length_description` | array | Provide a textual description of the item's length. Length typically refers to the longer or vertical dimension of an item. |
...
| `item_torque` | array | Provide the item's torque |
...
| `team_name` | array | Provide the name of the sports team associated with the baking pan, representing the team's branding or logo on the product. |
...
| `hard_disk` | array | The attribute indicates Hard Disk of the product |
| `is_oven_safe` | array | Item is oven safe |
| `length_range` | array | Length range for blinds |
| `waist` | array | The attribute indicates Waist of the product |
...
| `item_depth_width_height` | array | Provide the dimensions of the item when ready for use, like the length, width, and height of a fully unrolled rug. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | The attribute indicates the Deprecated Shaft Style Type of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Rim of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | Provide the size of the rim |

### item_length_description

Provide a textual description of the item's length. Length typically refers to the longer or vertical dimension of an item.

**Type:** array

**Title:** Item Length Description
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide a textual description of the item's length. Length typically refers to the longer or vertical dimension of an item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the appropriate shaft material |
...
- `203500 Inch Pounds, 16.08 Newton Meters`
...
Provide the name of the sports team associated with the baking pan, representing the team's branding or logo on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the baking pan, representing the team's branding or logo on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Hard Disk of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | Provide the data storage capacity of the hard disk drive in the product. |
...
The attribute indicates Waist of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `style` | array | No | Provide the item's waist style |
...
Provide the dimensions of the item when ready for use, like the length, width, and height of a fully unrolled rug.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back when lying on a surface. |
| `height` | object | Yes | Provide the height of the item from base to top when lying on a surface. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side when lying on a surface. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back when lying on a surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back when lying on a surface. |
...
Provide the width of the item from side to side when lying on a surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item from side to side when lying on a surface. |
