...
| `cooking_surface_area[item].unit` | Required in cooking_surface_area[item] object |
| `cooking_surface_area[item].value` | Required in cooking_surface_area[item] object |
...
| `frame[item].material[item].value` | Required in frame[item].material[item] object |
| `fuel_type[item].language_tag` | Required in fuel_type[item] object |
| `fuel_type[item].value` | Required in fuel_type[item] object |
...
| `has_automatic_shutoff[item].value` | Required in has_automatic_shutoff[item] object |
| `hazmat[item].aspect` | Required in hazmat[item] object |
| `hazmat[item].value` | Required in hazmat[item] object |
| `heating_power[item].unit` | Required in heating_power[item] object |
| `heating_power[item].value` | Required in heating_power[item] object |
...
| `item_dimensions[item].width.value` | Required in item_dimensions[item].width object |
| `item_dimensions_fraction[item].height.unit` | Required in item_dimensions_fraction[item].height object |
| `item_dimensions_fraction[item].height.unit` | Required in item_dimensions_fraction[item].height object |
| `item_dimensions_fraction[item].length.unit` | Required in item_dimensions_fraction[item].length object |
| `item_dimensions_fraction[item].length.unit` | Required in item_dimensions_fraction[item].length object |
| `item_dimensions_fraction[item].width.unit` | Required in item_dimensions_fraction[item].width object |
| `item_dimensions_fraction[item].width.unit` | Required in item_dimensions_fraction[item].width object |
...
| `item_torque[item].unit` | Required in item_torque[item] object |
| `item_torque[item].value` | Required in item_torque[item] object |
...
| `lithium_battery[item].weight[item].value` | Required in lithium_battery[item].weight[item] object |
| `main_burner_count[item].value` | Required in main_burner_count[item] object |
...
| `number_of_heating_elements[item].value` | Required in number_of_heating_elements[item] object |
...
| `number_of_power_levels[item].value` | Required in number_of_power_levels[item] object |
...
| `outside_diameter[item].unit` | Required in outside_diameter[item] object |
...
| `series_number[item].value` | Required in series_number[item] object |
| `ships_globally[item].value` | Required in ships_globally[item] object |
| `side_burner_count[item].value` | Required in side_burner_count[item] object |
...
| `trade_size_name[item].language_tag` | Required in trade_size_name[item] object |
| `trade_size_name[item].value` | Required in trade_size_name[item] object |
...
| `website_shipping_weight[item].unit` | Required in website_shipping_weight[item] object |
| `website_shipping_weight[item].value` | Required in website_shipping_weight[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the trade size name |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the model series number or generation of the product. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of fuel needed to power the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the power for the item's heating function. |
| `unit` | string | Yes | Provide the corresponding unit. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the item's torque (numeric) |
| `unit` | string | Yes | Select the corresponding unit |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Does item include automatic shutoff feature? |
| `marketplace_id` | object | No |  |
...
**Title:** Number of Heating Elements
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of heating elements that the item has |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of power levels that the item offers |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the outside diameter of the item |
| `marketplace_id` | object | No |  |
| `unit` | string | Yes | Select the corresponding unit |
...
| `height` | object | Yes | Provide the height of the item from base to top when placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width from side to side of the front of the item when placed in the manner it is expected to be used. |
...
Provide the height of the item from base to top when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from base to top when placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Select the unit of measure for the item height. |

#### item_depth_width_height[].width

Provide the width from side to side of the front of the item when placed in the manner it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width from side to side of the front of the item when placed in the manner it is expected to be used. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of side burners the item has. Side burners are additional cooking surfaces located on the side of the grill. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of main burners the item has. Main burners are used to heat up the primary grate section |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the total area of all effective cooking surfaces when the item is placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the cooking surface's area. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | No | The attribute indicates the Item Dimensions Fraction Height of the product |
| `length` | object | No | The attribute indicates the Item Dimensions Fraction Length of the product |
| `width` | object | No | The attribute indicates the Item Dimensions Fraction Width of the product |
| `marketplace_id` | object | No |  |

#### item_dimensions_fraction[].height

The attribute indicates the Item Dimensions Fraction Height of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the item height in decimal value |
| `unit` | string | Yes | Select the corresponding unit |

#### item_dimensions_fraction[].length

The attribute indicates the Item Dimensions Fraction Length of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the item width in decimal value |
| `string_value` | string | No | Provide the item length in string value |
| `unit` | string | Yes | Select the corresponding unit |

#### item_dimensions_fraction[].width

The attribute indicates the Item Dimensions Fraction Width of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the weight of the product when packaged to ship as a numeric value. This is displayed on the product page and used to calculate shipping costs for weight-based shipping, if applicable. |
| `unit` | string | Yes | Select the unit of measure for Website Shipping Weight. If a value is provided for Website Shipping Weight, you must also enter the corresponding unit. |
| `marketplace_id` | object | No |  |
