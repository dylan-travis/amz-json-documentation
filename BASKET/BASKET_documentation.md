...
| `team_name` | array | Provide the name of the sports team associated with the basket, representing the team's branding or affiliation. |
...
| `room_type` | array | Provide the intended room or space for using the item, such as living room, kitchen, or bathroom. |
| `width_range` | array | Width range for blinds |
| `closure` | array | The attribute indicates the Closure of the product |
| `item_depth_width_height` | array | Provide the dimensions of the item when ready for use, like a rug fully rolled out or a basket's actual size. |
...
Provide the name of the sports team associated with the basket, representing the team's branding or affiliation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the basket, representing the team's branding or affiliation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the intended room or space for using the item, such as living room, kitchen, or bathroom.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended room or area for the basket, influencing its design, size, and features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the dimensions of the item when ready for use, like a rug fully rolled out or a basket's actual size.
