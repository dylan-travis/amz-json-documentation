# BASKETBALL_HOOP Schema Documentation
...
|-----------|-------------|
| `base[item].dimensions[item].height` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].height` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].height.unit` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].height.unit` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].height.unit` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].height.value` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].height.value` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].height.value` | Required in base[item].dimensions[item].height object |
| `base[item].dimensions[item].length` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].length` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].length.unit` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].length.unit` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].length.unit` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].length.value` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].length.value` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].length.value` | Required in base[item].dimensions[item].length object |
| `base[item].dimensions[item].width` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].width` | Required in base[item].dimensions[item] object |
| `base[item].dimensions[item].width.unit` | Required in base[item].dimensions[item].width object |
| `base[item].dimensions[item].width.unit` | Required in base[item].dimensions[item].width object |
| `base[item].dimensions[item].width.unit` | Required in base[item].dimensions[item].width object |
| `base[item].dimensions[item].width.value` | Required in base[item].dimensions[item].width object |
| `base[item].dimensions[item].width.value` | Required in base[item].dimensions[item].width object |
| `base[item].dimensions[item].width.value` | Required in base[item].dimensions[item].width object |
| `basketball_backboard_dimensions[item].height` | Required in basketball_backboard_dimensions[item] object |
| `basketball_backboard_dimensions[item].height.unit` | Required in basketball_backboard_dimensions[item].height object |
| `basketball_backboard_dimensions[item].height.unit` | Required in basketball_backboard_dimensions[item].height object |
| `basketball_backboard_dimensions[item].height.value` | Required in basketball_backboard_dimensions[item].height object |
| `basketball_backboard_dimensions[item].height.value` | Required in basketball_backboard_dimensions[item].height object |
| `basketball_backboard_dimensions[item].width` | Required in basketball_backboard_dimensions[item] object |
| `basketball_backboard_dimensions[item].width.unit` | Required in basketball_backboard_dimensions[item].width object |
| `basketball_backboard_dimensions[item].width.unit` | Required in basketball_backboard_dimensions[item].width object |
| `basketball_backboard_dimensions[item].width.value` | Required in basketball_backboard_dimensions[item].width object |
| `basketball_backboard_dimensions[item].width.value` | Required in basketball_backboard_dimensions[item].width object |
...
| `golf_club_loft[item].unit` | Required in golf_club_loft[item] object |
...
| `maximum_height_recommendation[item].unit` | Required in maximum_height_recommendation[item] object |
| `maximum_height_recommendation[item].value` | Required in maximum_height_recommendation[item] object |
...
| `overhang_distance[item].unit` | Required in overhang_distance[item] object |
| `overhang_distance[item].value` | Required in overhang_distance[item] object |
...
- `maximum_height_recommendation.value` - Required when `maximum_height_recommendation` is provided
- `maximum_height_recommendation.unit` - Required when `maximum_height_recommendation` is provided
...
- `overhang_distance.value` - Required when `overhang_distance` is provided
- `overhang_distance.unit` - Required when `overhang_distance` is provided
- `basketball_backboard_dimensions.height` - Required when `basketball_backboard_dimensions` is provided
- `basketball_backboard_dimensions.width` - Required when `basketball_backboard_dimensions` is provided
...
| `mounting_type` | array | Provide the way the basketball hoop is attached or secured, indicating how it is installed or positioned for use. |
...
| `league_name` | array | Provide the governing body or association that sets standards for the basketball hoop's size and construction. |
| `team_name` | array | Provide the name of the sports team associated with the basketball hoop, representing the team's branding on the product. |
...
| `room_type` | array | Provide the intended room or area for the basketball hoop, which may affect its size, features, or design. |
| `maximum_height_recommendation` | array | Provide the products maximum height recommendation |
...
| `overhang_distance` | array | Provide the measurement from the front of the backboard to the closest point of the supporting pole or structure. |
| `basketball_backboard_dimensions` | array | Provide the dimensions of the basketball backboard. Backboard dimensions describes the width and height of the basketball backboard. |
...
- `Wall mount basketball backboards`
...
Provide the way the basketball hoop is attached or secured, indicating how it is installed or positioned for use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the basketball hoop is attached or secured, indicating how it is installed or positioned for use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the governing body or association that sets standards for the basketball hoop's size and construction.
...
Provide the name of the sports team associated with the basketball hoop, representing the team's branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the basketball hoop, representing the team's branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `dimensions` | array | No | Provide the length, width and height of the item's base. |
| `marketplace_id` | object | No |  |
...
| `type` | array | No | The type of grip on the fencing instrument. |
...
Provide the intended room or area for the basketball hoop, which may affect its size, features, or design.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended room or area for the basketball hoop, which may affect its size, features, or design. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### maximum_height_recommendation

Provide the products maximum height recommendation

**Type:** array

**Title:** Maximum Height Recommendation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the products maximum height recommendation |
| `unit` | string | Yes | Provide the corresponding unit used to designate the basketball hoop's maximum recommended height. |
| `marketplace_id` | object | No |  |
...
| `height` | object | Yes | Provide the height of the item in unexpanded, ready to use condition. The height is measured from the base to the top standing in upright position. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item wheel to wheel in ready to use condition. |
...
Provide the height of the item in unexpanded, ready to use condition. The height is measured from the base to the top standing in upright position.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item in unexpanded, ready to use condition. The height is measured from the base to the top standing in upright position. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s height. |

#### item_depth_width_height[].width

Provide the width of the item wheel to wheel in ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item wheel to wheel in ready to use condition. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s width. |

### overhang_distance

Provide the measurement from the front of the backboard to the closest point of the supporting pole or structure.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement from the front of the backboard to the closest point of the supporting pole or structure. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the distance from the backboard to the supporting structure. |
| `marketplace_id` | object | No |  |

### basketball_backboard_dimensions

Provide the dimensions of the basketball backboard. Backboard dimensions describes the width and height of the basketball backboard.

**Type:** array

**Title:** Basketball Backboard Dimensions

**Required:** No

**Examples:**

- `Width: 54 Inches, Height: 33 Inches`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the basketball backboard included with the item. The height is measured from the top to the bottom of the backboard. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the basketball backboard included with the item. The width is measured from one side of the backboard to the next. |

#### basketball_backboard_dimensions[].height

Provide the height of the basketball backboard included with the item. The height is measured from the top to the bottom of the backboard.

**Type:** object

**Title:** Basketball Backboard Height
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the basketball backboard included with the item. The height is measured from the top to the bottom of the backboard. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the height of the basketball backboard included with the item. |

#### basketball_backboard_dimensions[].width

Provide the width of the basketball backboard included with the item. The width is measured from one side of the backboard to the next.

**Type:** object

**Title:** Basketball Backboard Width
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the basketball backboard included with the item. The width is measured from one side of the backboard to the next. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the width of the basketball backboard included with the item. |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the basketball hoop's lowest possible height. |
| `marketplace_id` | object | No |  |
