...
| `age_range_description` | array | Provide the age group the item is designed for, indicating who can safely use or sleep on it. |
...
| `compartment` | array | The attribute indicates Compartment of the product |
| `item_display_dimensions` | array | Provide the dimensions of the product, without packaging and fully assembled |
| `form_factor` | array | What are the outward design characteristics of the item |
...
| `headboard` | array | Provide the specifications of the item's headboard. |
| `bunk_bed_configuration` | array | Provide the layout of the bunk bed that describes how the different bed layers are oriented towards one another. |
...
Provide the age group the item is designed for, indicating who can safely use or sleep on it.
...
The attribute indicates Compartment of the product
...
What are the outward design characteristics of the item
...
Provide the specifications of the item's headboard.
...
Provide the layout of the bunk bed that describes how the different bed layers are oriented towards one another.
