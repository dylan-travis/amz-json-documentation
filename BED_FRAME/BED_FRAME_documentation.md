# BED_FRAME Schema Documentation
...
| `compatible_with_mattress_size[item].language_tag` | Required in compatible_with_mattress_size[item] object |
| `compatible_with_mattress_size[item].value` | Required in compatible_with_mattress_size[item] object |
...
- `compatible_with_mattress_size.value` - Required when `compatible_with_mattress_size` is provided
- `compatible_with_mattress_size.language_tag` - Required when `compatible_with_mattress_size` is provided
...
- `bunk_bed_configuration.value` - Required when `bunk_bed_configuration` is provided
- `bunk_bed_configuration.language_tag` - Required when `bunk_bed_configuration` is provided
...
| `special_feature` | array | Provide the unique characteristics that set this bed frame apart from similar products, enhancing its functionality or appeal. |
| `style` | array | The style of the item |
| `age_range_description` | array | Provide the age group the item is designed for, indicating the appropriate user age range, ensuring proper size and safety. |
...
| `form_factor` | array | Provide the outward design characteristics of the bed frame, indicating its overall structure and appearance. |
...
| `team_name` | array | Provide the name of the sports team associated with the bed frame design or branding. |
| `is_fragile` | array | Is the item fragile? |
| `scent` | array | Provide a description of the scent of the item |
| `compatible_with_mattress_size` | array | Provide the mattress size the item can accommodate, the dimensions it's designed to fit. |
...
| `bunk_bed_configuration` | array | Provide the layout of the bunk bed, describing how the different bed layers are arranged in relation to each other. |
...
Provide the unique characteristics that set this bed frame apart from similar products, enhancing its functionality or appeal.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this bed frame apart from similar products, enhancing its functionality or appeal. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the age group the item is designed for, indicating the appropriate user age range, ensuring proper size and safety.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended age range for the bed frame, indicating the appropriate user group for the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the outward design characteristics of the bed frame, indicating its overall structure and appearance.
...
Provide the name of the sports team associated with the bed frame design or branding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the bed frame design or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the mattress size the item can accommodate, the dimensions it's designed to fit.

**Type:** array

**Title:** Compatible With Mattress Size

**Required:** No

**Examples:**

- `Queen, Full, 91 x 41 cm`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the mattress sizes that fit with the bed frame, indicating the dimensions of compatible mattresses. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `length` | object | Yes | Provide the length of the item in ready to use condition. Length is measured from the head side of the bed frame to the toe. |
| `marketplace_id` | object | No |  |
...
Provide the length of the item in ready to use condition. Length is measured from the head side of the bed frame to the toe.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item in ready to use condition. Length is measured from the head side of the bed frame to the toe. |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the bed frame's clearance from the ground. |
| `marketplace_id` | object | No |  |

### bunk_bed_configuration

Provide the layout of the bunk bed, describing how the different bed layers are arranged in relation to each other.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the layout of the bunk bed, describing how the different bed layers are arranged in relation to each other. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
