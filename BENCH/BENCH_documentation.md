...
| `team_name` | array | Provide the name of the sports team associated with the bench, indicating the team affiliation or branding of the seating product. |
...
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely support, the highest load it can bear without breaking or becoming unstable. |
...
Provide the name of the sports team associated with the bench, indicating the team affiliation or branding of the seating product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the bench, indicating the team affiliation or branding of the seating product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely support, the highest load it can bear without breaking or becoming unstable.
