# BICYCLE_TRAILER Schema Documentation
...
| `team_name` | array | Provide the name of the sports team associated with the bicycle trailer, indicating any team-specific branding or design elements. |
...
| `seating_group` | array |  |
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely carry, the highest load it's designed to support without issues. |
...
Provide the name of the sports team associated with the bicycle trailer, indicating any team-specific branding or design elements.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the bicycle trailer, indicating any team-specific branding or design elements. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely carry, the highest load it's designed to support without issues.
