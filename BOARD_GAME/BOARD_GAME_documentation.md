# BOARD_GAME Schema Documentation
...
| `age_gender_category[item].language_tag` | Required in age_gender_category[item] object |
| `age_gender_category[item].value` | Required in age_gender_category[item] object |
| `assembly_time[item].value` | Required in assembly_time[item] object |
| `band[item].color[item].language_tag` | Required in band[item].color[item] object |
| `band[item].color[item].language_tag` | Required in band[item].color[item] object |
| `band[item].color[item].value` | Required in band[item].color[item] object |
| `band[item].color[item].value` | Required in band[item].color[item] object |
...
| `compliance_card_type[item].value` | Required in compliance_card_type[item] object |
| `compliance_game_type[item].value` | Required in compliance_game_type[item] object |
...
| `compliance_operation_mode[item].value` | Required in compliance_operation_mode[item] object |
...
| `estimated_playing_time[item].unit` | Required in estimated_playing_time[item] object |
| `estimated_playing_time[item].value` | Required in estimated_playing_time[item] object |
...
| `generic_type[item].language_tag` | Required in generic_type[item] object |
| `generic_type[item].value` | Required in generic_type[item] object |
| `genre[item].language_tag` | Required in genre[item] object |
| `genre[item].value` | Required in genre[item] object |
...
| `item_length_width[item].length` | Required in item_length_width[item] object |
| `item_length_width[item].length.unit` | Required in item_length_width[item].length object |
| `item_length_width[item].length.unit` | Required in item_length_width[item].length object |
| `item_length_width[item].length.value` | Required in item_length_width[item].length object |
| `item_length_width[item].length.value` | Required in item_length_width[item].length object |
| `item_length_width[item].width` | Required in item_length_width[item] object |
| `item_length_width[item].width.unit` | Required in item_length_width[item].width object |
| `item_length_width[item].width.unit` | Required in item_length_width[item].width object |
| `item_length_width[item].width.value` | Required in item_length_width[item].width object |
| `item_length_width[item].width.value` | Required in item_length_width[item].width object |
...
| `material_composition[item].language_tag` | Required in material_composition[item] object |
| `material_composition[item].value` | Required in material_composition[item] object |
...
- `estimated_playing_time` - Required when selectors `marketplace_id`, `unit` are specified
...
- `genre.value` - Required when `genre` is provided
- `genre.language_tag` - Required when `genre` is provided
...
- `generic_type.value` - Required when `generic_type` is provided
- `generic_type.language_tag` - Required when `generic_type` is provided
...
- `estimated_playing_time.value` - Required when `estimated_playing_time` is provided
- `estimated_playing_time.unit` - Required when `estimated_playing_time` is provided
...
- `compliance_game_type.value` - Required when `compliance_game_type` is provided
- `compliance_card_type.value` - Required when `compliance_card_type` is provided
...
| `subject_character` | array | Provide the main character or theme the item is based on, the central figure, story, or concept it represents. |
...
| `genre` | array | Specify the genre of this item. |
...
| `customer_package_type` | array | Provide the packaging option for the item, how the game components are bundled and sold to customers. |
| `operation_mode` | array | Provide the way the item is intended to be used or played with, how it functions or operates during playtime. |
| `pattern` | array | Provide the most prominent repeated decorative design of the item |
| `unit_count` | array | Provide the total number and type of pieces or components included in the item, such as game pieces, cards, or tokens. |
...
| `generic_type` | array | variation type |
...
| `estimated_playing_time` | array | Provide the estimated length of time to complete a single session of play. |
...
| `compliance_game_type` | array | Provide the kind of play the item is designated to provide, for compliance purposes. |
| `compliance_card_type` | array | Provide the style of card associated with the item, for compliance purposes. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the department where the product should be found |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main character or theme the item is based on, the central figure, story, or concept it represents.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide secondary brand information related to the product such as licensed or franchise |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the item's material composition with each material separated by a comma, indicated with % composition and adding up to 100 in descending order |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Specify the genre of this item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide an appropriate genre for the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the packaging option for the item, how the game components are bundled and sold to customers.
...
Provide the way the item is intended to be used or played with, how it functions or operates during playtime.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the item's operation mode |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the total number and type of pieces or components included in the item, such as game pieces, cards, or tokens.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `color` | array | No | Describe the color of the band. |
| `marketplace_id` | object | No |  |
...
- `oil based paint, acrylic based paint`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | variation type |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the length of the item when lying on a surface. The length is measured along the longer horizontal edge. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item when lying on a surface. The width is measured along the shorter horizontal edge. |

#### item_length_width[].length

Provide the length of the item when lying on a surface. The length is measured along the longer horizontal edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item when lying on a surface. The length is measured along the longer horizontal edge. |
| `unit` | string | Yes | Provide the unit of measure used to measure the item's length. |

#### item_length_width[].width

Provide the width of the item when lying on a surface. The width is measured along the shorter horizontal edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item when lying on a surface. The width is measured along the shorter horizontal edge. |
| `unit` | string | Yes | Provide the unit of measure used to measure the item's width. |

### estimated_playing_time

Provide the estimated length of time to complete a single session of play.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the estimated length of time to complete a single session of play. |
| `unit` | string | Yes | Provide the unit of measure used to estimate the length of time taken to complete a single session of play. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select relevant cautionary statements for the product as defined in Section 24 of the FHSA and section 105 of the CPSIA.  The statements must be displayed on the product packaging and it is your responsibility to supply relevant statements |
| `marketplace_id` | object | No |  |
...
### compliance_game_type

Provide the kind of play the item is designated to provide, for compliance purposes.

**Type:** array

**Title:** Compliance - Game Type

**Required:** No

**Examples:**

- `Card Game, Bingo, Board Game`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the kind of play the item is designated to provide, for compliance purposes. |
| `marketplace_id` | object | No |  |

### compliance_card_type

Provide the style of card associated with the item, for compliance purposes.

**Type:** array

**Title:** Compliance - Card Type

**Required:** No

**Examples:**

- `Bridge Cards, Poker Game Cards`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the style of card associated with the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
**Title:** Compliance - Operation Mode
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the source of energy used by the item; for compliance purposes. Non-battery refers to a wired connection to an outlet. |
| `marketplace_id` | object | No |  |
