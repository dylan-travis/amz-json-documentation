...
| `current_rating[item].unit` | Required in current_rating[item] object |
| `current_rating[item].value` | Required in current_rating[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | provide the current rating value |
| `unit` | string | Yes | Select the corresponding unit |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the bottle opener is designed to be attached or positioned for use, such as on a wall or tabletop. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the physical configuration or shape of the bottle opener, indicating its design and functionality. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the bottle opener, indicating the team branding or affiliation of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
