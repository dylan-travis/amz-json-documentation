# BOTTLE_RACK Schema Documentation
...
| `battery[item].weight[item].value` | Required in battery[item].weight[item] object |
| `bottle_count[item].value` | Required in bottle_count[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Specify the number of bottles that the item comes with or supports |
| `marketplace_id` | object | No |  |
