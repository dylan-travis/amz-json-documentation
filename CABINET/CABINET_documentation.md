...
| `back[item].material[item].value` | Required in back[item].material[item] object |
| `base[item].width[item].unit` | Required in base[item].width[item] object |
| `base[item].width[item].unit` | Required in base[item].width[item] object |
| `base[item].width[item].value` | Required in base[item].width[item] object |
| `base[item].width[item].value` | Required in base[item].width[item] object |
...
| `construction_type[item].language_tag` | Required in construction_type[item] object |
| `construction_type[item].value` | Required in construction_type[item] object |
...
| `door[item].orientation[item].language_tag` | Required in door[item].orientation[item] object |
| `door[item].orientation[item].language_tag` | Required in door[item].orientation[item] object |
| `door[item].orientation[item].value` | Required in door[item].orientation[item] object |
| `door[item].orientation[item].value` | Required in door[item].orientation[item] object |
| `door[item].style[item].language_tag` | Required in door[item].style[item] object |
| `door[item].style[item].language_tag` | Required in door[item].style[item] object |
| `door[item].style[item].value` | Required in door[item].style[item] object |
| `door[item].style[item].value` | Required in door[item].style[item] object |
...
| `item_depth[item].language_tag` | Required in item_depth[item] object |
| `item_depth[item].value` | Required in item_depth[item] object |
...
| `num_of_shelves[item].value` | Required in num_of_shelves[item] object |
...
| `number_of_levels[item].value` | Required in number_of_levels[item] object |
...
| `package_type_name[item].language_tag` | Required in package_type_name[item] object |
| `package_type_name[item].value` | Required in package_type_name[item] object |
...
| `reservoir_capacity[item].value` | Required in reservoir_capacity[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the products construction type |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of locking mechanism used on the cabinet, indicating how the doors or drawers are secured. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the storage capacity of the cabinet. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the product's item depth |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the quantity of storage racks or compartments included with the cabinet for organizing and storing items. |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `orientation` | array | No | Provide the item's door orientation. |
| `style` | array | No | Represents the type of door for an item of furniture. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the industry standards or specifications the cabinet has met, indicating compliance with relevant quality or safety requirements. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the method of setting up the cabinet, indicating whether it is self-supporting or requires attachment to a wall. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the cabinet is designed to be attached or positioned, indicating its installation method or placement in a space. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the item's packaging type |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the cabinet, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the best option for the material on the back of the item. |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `width` | array | No | Provide the width of the item's base |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the reservoir capacity |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended room for the cabinet, indicating its design purpose and suitability for specific areas in a home or building. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the quantity of horizontal surfaces or compartments within the cabinet for storing or displaying items. |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the cabinet's clearance from the ground. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the count of shelves included with the cabinet, indicating the storage capacity and organization options available. |
| `marketplace_id` | object | No |  |
