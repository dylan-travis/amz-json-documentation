# CANDLE_HOLDER Schema Documentation
...
| `candle_holder_form[item].language_tag` | Required in candle_holder_form[item] object |
| `candle_holder_form[item].value` | Required in candle_holder_form[item] object |
...
| `digital_storage_capacity[item].unit` | Required in digital_storage_capacity[item] object |
| `digital_storage_capacity[item].value` | Required in digital_storage_capacity[item] object |
...
- `digital_storage_capacity.value` - Required when `digital_storage_capacity` is provided
- `digital_storage_capacity.unit` - Required when `digital_storage_capacity` is provided
...
- `candle_holder_form.value` - Required when `candle_holder_form` is provided
- `candle_holder_form.language_tag` - Required when `candle_holder_form` is provided
...
| `department` | array | Provide the gender/age for which this item is intended |
...
| `occasion_type` | array | Provide the special event or purpose the item is designed for, like holidays, ceremonies, or general home decor. |
...
| `connectivity_technology` | array | Specify the product's wired connectivity technology. |
| `wattage` | array | The wattage rating of the product. Input a number only--do not enter units. |
| `digital_storage_capacity` | array | Provide the product's digital storage capacity |
| `pattern` | array | Provide the most prominent repeated decorative design of the item |
| `mounting_type` | array | Provide the way the item is designed to be secured, whether freestanding, wall-mounted, or suspended. |
...
| `team_name` | array | Provide the name of the sports team associated with the candle holder, indicating the team-themed design or branding on the product. |
...
| `candle_holder_form` | array | Provide the specific form of the candle holder. The candle holder form is primarily defined by the candle holder overall shape and distinct design features. |
...
Provide the gender/age for which this item is intended
...
Provide the special event or purpose the item is designed for, like holidays, ceremonies, or general home decor.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event for which the candle holder is designed, such as religious ceremonies or celebrations. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Specify the product's wired connectivity technology.
...
Provide the product's digital storage capacity

**Type:** array

**Title:** Digital Storage Capacity
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the product's digital storage capacity as a numeric value |
| `unit` | string | Yes | Select the corresponding unit |
| `marketplace_id` | object | No |  |
...
Provide the way the item is designed to be secured, whether freestanding, wall-mounted, or suspended.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the candle holder is designed to be attached or positioned, such as freestanding, wall-mounted, or suspended. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the candle holder, indicating the team-themed design or branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the candle holder, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the specific form of the candle holder. The candle holder form is primarily defined by the candle holder overall shape and distinct design features.

**Type:** array

**Title:** Candle Holder Form
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific form of the candle holder. The candle holder form is primarily defined by the candle holder overall shape and distinct design features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
