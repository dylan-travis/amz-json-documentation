...
| `chair_backrest_width[item].unit` | Required in chair_backrest_width[item] object |
| `chair_backrest_width[item].value` | Required in chair_backrest_width[item] object |
...
| `leg[item].style[item].language_tag` | Required in leg[item].style[item] object |
| `leg[item].style[item].language_tag` | Required in leg[item].style[item] object |
| `leg[item].style[item].value` | Required in leg[item].style[item] object |
| `leg[item].style[item].value` | Required in leg[item].style[item] object |
...
| `seat[item].height[item].value` | Required in seat[item].height[item] object |
| `seat[item].length[item].language_tag` | Required in seat[item].length[item] object |
| `seat[item].length[item].language_tag` | Required in seat[item].length[item] object |
| `seat[item].length[item].value` | Required in seat[item].length[item] object |
| `seat[item].length[item].value` | Required in seat[item].length[item] object |
| `seat[item].material_type[item].language_tag` | Required in seat[item].material_type[item] object |
| `seat[item].material_type[item].language_tag` | Required in seat[item].material_type[item] object |
| `seat[item].material_type[item].value` | Required in seat[item].material_type[item] object |
| `seat[item].material_type[item].value` | Required in seat[item].material_type[item] object |
...
| `surface_recommendation[item].language_tag` | Required in surface_recommendation[item] object |
| `surface_recommendation[item].value` | Required in surface_recommendation[item] object |
...
| `item_type_keyword` | array | Provide the specific type of chair, helping to categorize the item within the furniture catalog. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific type of chair, helping to categorize the item within the furniture catalog. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this chair apart from similar products, enhancing its functionality or design. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended age range for the chair, indicating the appropriate user group for the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the chair, indicating the design or theme of the furniture item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `style` | array | No | This attribute indicates the style of the item's leg or legs |
...
| `marketplace_id` | object | No |  |
| `style` | array | No | Provide a description of the the style of the item's arm(s) |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of surface the chair is designed to be used on, such as indoor or outdoor settings. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the chair, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the design or type of cushion used in the chair, describing its shape, material, or unique features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the chair can tilt or change its angle, allowing for adjustment of the seat's viewing angle or position. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the chair is designed or intended for use in, which may influence its size, features, or aesthetics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `length` | array | No | Provide the length of the seating area on the item, the space where you sit, which affects comfort and fit. |
| `marketplace_id` | object | No |  |
| `material_type` | array | No | Provide the material the seat and/or cushion of the product is made from. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of movement allowed by the chair's base, indicating how it enables the chair to spin or move vertically or horizontally. |
| `marketplace_id` | object | No |  |
...
Provide the number of reclining positions the item offers, based on its adjustable mechanism.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the number of adjustable reclining positions the chair offers, indicating its range of comfort settings. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the chair's backrest, measured at the widest point on the backrest. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the width of the chair's backrest, measured at its widest point. |
| `marketplace_id` | object | No |  |
