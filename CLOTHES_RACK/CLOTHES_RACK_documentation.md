# CLOTHES_RACK Schema Documentation
...
| `lithium_battery[item].weight[item].value` | Required in lithium_battery[item].weight[item] object |
| `load_capacity[item].unit` | Required in load_capacity[item] object |
| `load_capacity[item].value` | Required in load_capacity[item] object |
...
| `style` | array | Provide the aesthetic design of the clothes rack, describing its visual appearance and distinctive features. |
...
| `furniture_finish` | array | Provide a description of the furniture's finish |
| `installation_type` | array | Provide the method of setting up the clothes rack, indicating how it is positioned or attached for use. |
...
| `maximum_weight_recommendation` | array | Provide the highest weight the item can safely hold without issues, the maximum load capacity for proper functioning. |
...
Provide the aesthetic design of the clothes rack, describing its visual appearance and distinctive features.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the aesthetic design of the clothes rack, describing its visual appearance and distinctive features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the maximum load capacity |
| `marketplace_id` | object | No |  |
| `unit` | string | Yes | Provide the appropriate unit of the load capacity |

### furniture_finish

Provide a description of the furniture's finish
...
Provide the method of setting up the clothes rack, indicating how it is positioned or attached for use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the method of setting up the clothes rack, indicating how it is positioned or attached for use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the highest weight the item can safely hold without issues, the maximum load capacity for proper functioning.
