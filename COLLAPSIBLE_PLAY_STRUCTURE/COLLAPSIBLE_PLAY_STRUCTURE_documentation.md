# COLLAPSIBLE_PLAY_STRUCTURE Schema Documentation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for using the collapsible play structure, indicating the intended user group for safe and appropriate play. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
