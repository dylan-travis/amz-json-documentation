...
| `door[item].material_type[item].language_tag` | Required in door[item].material_type[item] object |
| `door[item].material_type[item].language_tag` | Required in door[item].material_type[item] object |
| `door[item].material_type[item].value` | Required in door[item].material_type[item] object |
| `door[item].material_type[item].value` | Required in door[item].material_type[item] object |
...
| `temperature_range[item].language_tag` | Required in temperature_range[item] object |
| `temperature_range[item].unit` | Required in temperature_range[item] object |
| `temperature_range[item].value` | Required in temperature_range[item] object |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material_type` | array | No | Enter the type of material the door is made of. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the temperature range of the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | array | No | Provide the length of the cable |
| `marketplace_id` | object | No |  |
