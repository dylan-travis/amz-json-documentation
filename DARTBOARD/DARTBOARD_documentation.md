# DARTBOARD Schema Documentation
...
| `sport_type` | array | Provide the type of sport the item is designed for, such as shooting, archery, or ball sports for training. |
| `league_name` | array | Name of league associated with this event. |
| `team_name` | array | Provide the name of the sports team associated with the dartboard, indicating the team-specific design or branding of the product. |
...
Provide the type of sport the item is designed for, such as shooting, archery, or ball sports for training.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific sports for which the target is designed, indicating its intended use in shooting, projectile, or practice activities. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the dartboard, indicating the team-specific design or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the dartboard, indicating the team-specific design or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
