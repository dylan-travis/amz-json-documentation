...
| `base[item].curve_radius[item].value` | Required in base[item].curve_radius[item] object |
| `base[item].curve_radius[item].value` | Required in base[item].curve_radius[item] object |
...
| `optical_power[item].value` | Required in optical_power[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `curve_radius` | array | No | Provide the base curve radius of the lens |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the item's optical power as a numeric value |
| `marketplace_id` | object | No |  |
