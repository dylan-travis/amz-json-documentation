...
| `mounting_type` | array | Provide the way the dresser is designed to be installed or secured, indicating how it attaches to a surface or structure. |
...
| `team_name` | array | Provide the name of the sports team associated with the dresser, indicating the team-themed design or branding on the furniture. |
...
| `room_type` | array | Provide the room the item is intended for, where it will be placed and used, like a bedroom or living room. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of drawer mechanism used in the dresser, indicating how the drawers open and close. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the dresser is designed to be installed or secured, indicating how it attaches to a surface or structure.
...
Provide the name of the sports team associated with the dresser, indicating the team-themed design or branding on the furniture.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the dresser, indicating the team-themed design or branding on the furniture. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the room the item is intended for, where it will be placed and used, like a bedroom or living room.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the dresser is designed for, indicating its intended placement and use within a home. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the minimum doorway width needed for the dresser to fit through. |
| `marketplace_id` | object | No |  |
