# ELECTRIC_LIGHT Schema Documentation
...
| `battery[item].average_life[item].unit` | Required in battery[item].average_life[item] object |
| `battery[item].average_life[item].unit` | Required in battery[item].average_life[item] object |
| `battery[item].average_life[item].value` | Required in battery[item].average_life[item] object |
| `battery[item].average_life[item].value` | Required in battery[item].average_life[item] object |
...
| `brightness[item].language_tag` | Required in brightness[item] object |
| `brightness[item].value` | Required in brightness[item] object |
| `bulb[item].base[item].value` | Required in bulb[item].base[item] object |
| `bulb[item].base[item].value` | Required in bulb[item].base[item] object |
| `bulb[item].shape_size[item].value` | Required in bulb[item].shape_size[item] object |
| `bulb[item].shape_size[item].value` | Required in bulb[item].shape_size[item] object |
...
| `color_rendering_index[item].value` | Required in color_rendering_index[item] object |
| `color_temperature[item].unit` | Required in color_temperature[item] object |
| `color_temperature[item].value` | Required in color_temperature[item] object |
...
| `light_output_maximum[item].unit` | Required in light_output_maximum[item] object |
| `light_output_maximum[item].value` | Required in light_output_maximum[item] object |
| `light_source[item].special_features[item].language_tag` | Required in light_source[item].special_features[item] object |
| `light_source[item].special_features[item].language_tag` | Required in light_source[item].special_features[item] object |
| `light_source[item].special_features[item].value` | Required in light_source[item].special_features[item] object |
| `light_source[item].special_features[item].value` | Required in light_source[item].special_features[item] object |
| `light_source[item].type[item].language_tag` | Required in light_source[item].type[item] object |
| `light_source[item].type[item].language_tag` | Required in light_source[item].type[item] object |
| `light_source[item].type[item].value` | Required in light_source[item].type[item] object |
| `light_source[item].type[item].value` | Required in light_source[item].type[item] object |
...
| `maximum_compatible_light_source_wattage[item].unit` | Required in maximum_compatible_light_source_wattage[item] object |
| `maximum_compatible_light_source_wattage[item].value` | Required in maximum_compatible_light_source_wattage[item] object |
...
| `number_of_light_sources[item].value` | Required in number_of_light_sources[item] object |
...
| `shade[item].material[item].language_tag` | Required in shade[item].material[item] object |
| `shade[item].material[item].language_tag` | Required in shade[item].material[item] object |
| `shade[item].material[item].value` | Required in shade[item].material[item] object |
| `shade[item].material[item].value` | Required in shade[item].material[item] object |
...
- `color_rendering_index.value` - Required when `color_rendering_index` is provided
...
- `maximum_compatible_light_source_wattage.value` - Required when `maximum_compatible_light_source_wattage` is provided
- `maximum_compatible_light_source_wattage.unit` - Required when `maximum_compatible_light_source_wattage` is provided
...
- `light_output_maximum.value` - Required when `light_output_maximum` is provided
- `light_output_maximum.unit` - Required when `light_output_maximum` is provided
...
| `color_rendering_index` | array | Provide the product's color rendering index |
...
| `maximum_compatible_light_source_wattage` | array | Provide the maximum compatible light source wattage |
...
| `amperage` | array | Provide the electrical current the item uses or requires, the rate of flow of electric charge, related to power consumption. |
| `pattern` | array | Provide the most prominent repeated decorative design of the item |
| `mounting_type` | array | Provide the way the item is installed or attached, how it is positioned for use, like on a wall or ceiling. |
...
| `light_output_maximum` | array | Provide the maximum light output which is the total amount of visible light emitted by the light source in all directions measured in lumens. |
...
| `num_batteries` | array | Provide the number and type of batteries needed to power the item, required for portable operation. |
...
Provide the product's color rendering index
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the product's color rendering index |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the color temperature of the product as a numeric value |
| `unit` | string | Yes | Provide the corresponding unit used to designate the electric light's color temperature. |
| `marketplace_id` | object | No |  |

### maximum_compatible_light_source_wattage

Provide the maximum compatible light source wattage

**Type:** array

**Title:** Maximum Compatible Light Source Wattage
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum compatible light source wattage as a numeric value |
| `unit` | string | Yes | Provide the corresponding unit used to designate the maximum wattage of the electric light's compatible light source. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the industry standards or specifications the product has met |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the electrical current the item uses or requires, the rate of flow of electric charge, related to power consumption.
...
Provide the way the item is installed or attached, how it is positioned for use, like on a wall or ceiling.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the light is attached or fixed in place, indicating how it is installed or positioned for use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the brightness of the product as a numeric value |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `base` | array | No | Select the corresponding code for the base of the bulb |
| `marketplace_id` | object | No |  |
| `shape_size` | array | No | Select the corresponding code for the shape and size of the bulb |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `special_features` | array | No | Provide the special capabilities of the item's light source, additional functions beyond basic illumination. |
| `type` | array | No | Specify the type of light source the product has |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Describe the material of the item's shade |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of light sources the product has |
| `marketplace_id` | object | No |  |
...
### light_output_maximum

Provide the maximum light output which is the total amount of visible light emitted by the light source in all directions measured in lumens.

**Type:** array

**Title:** Light Output Maximum
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the maximum light output which represents the total amount of visible light emitted by the light source in all directions in lumens. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's maximum light output. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `average_life` | array | No | Provide the estimated battery life of the device based how long it can consistently operate when fully charged. |
...
| `description` | array | No | Provide the details about the battery used to power the item, its type, capacity, and other relevant specifications. |
...
Provide the number and type of batteries needed to power the item, required for portable operation.
