# ELLIPTICAL_TRAINER Schema Documentation
...
| `exercise_machine_arm_type[item].value` | Required in exercise_machine_arm_type[item] object |
...
| `heart_rate_sensor_type[item].value` | Required in heart_rate_sensor_type[item] object |
...
| `maximum_stride_length[item].unit` | Required in maximum_stride_length[item] object |
| `maximum_stride_length[item].value` | Required in maximum_stride_length[item] object |
...
| `number_of_resistance_levels[item].value` | Required in number_of_resistance_levels[item] object |
...
| `resistance_mechanism[item].language_tag` | Required in resistance_mechanism[item] object |
| `resistance_mechanism[item].value` | Required in resistance_mechanism[item] object |
...
| `space_efficiency[item].value` | Required in space_efficiency[item] object |
...
- `resistance_mechanism.value` - Required when `resistance_mechanism` is provided
- `resistance_mechanism.language_tag` - Required when `resistance_mechanism` is provided
...
- `maximum_stride_length.value` - Required when `maximum_stride_length` is provided
- `maximum_stride_length.unit` - Required when `maximum_stride_length` is provided
...
- `number_of_resistance_levels.value` - Required when `number_of_resistance_levels` is provided
- `space_efficiency.value` - Required when `space_efficiency` is provided
- `heart_rate_sensor_type.value` - Required when `heart_rate_sensor_type` is provided
- `exercise_machine_arm_type.value` - Required when `exercise_machine_arm_type` is provided
...
| `resistance_mechanism` | array | Provide the mechanism that controls the resistance level during exercise, adjusting the intensity of the workout. |
...
| `team_name` | array | Provide the name representing the item, identifying it from others, like a team or group name. |
...
| `space_efficiency` | array | Select an appropriate value to indicate the product’s space efficiency |
| `heart_rate_sensor_type` | array | Select the method by which a person’s heart rate can be monitored when using this product |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | Size of the screen included with this product. |
...
Provide the mechanism that controls the resistance level during exercise, adjusting the intensity of the workout.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the resistance mechanism used to control the level of opposing forces provided by the item when in use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name representing the item, identifying it from others, like a team or group name.
...
Provide the maximum stride length

**Type:** array

**Title:** Maximum Stride Length
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum stride length |
| `unit` | string | Yes | Specify the corresponding unit |
| `marketplace_id` | object | No |  |

### maximum_weight_recommendation

Provide the maximum weight the item can safely support, the highest user weight it is designed to handle.
...
Provide the number of difficulty settings the item offers for adjusting the workout intensity.

**Type:** array

**Title:** Number of Resistance Levels
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of resistance levels that the item offers |
| `marketplace_id` | object | No |  |

### space_efficiency

Select an appropriate value to indicate the product’s space efficiency
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select an appropriate value to indicate the product’s space efficiency |
| `marketplace_id` | object | No |  |

### heart_rate_sensor_type

Select the method by which a person’s heart rate can be monitored when using this product

**Type:** array

**Title:** Heart Rate Sensor Type

**Required:** No

**Examples:**

- `Chest Strap, Hand Grip, Telemetry`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select the method by which a person’s heart rate can be monitored when using this product |
| `marketplace_id` | object | No |  |

### exercise_machine_arm_type

Select the type of arm component that is present on the exercise machine

**Type:** array

**Title:** Exercise Machine Arm Type

**Required:** No

**Examples:**

- `Grip Handles, Handlebars, Resistance Bands`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select the type of arm component that is present on the exercise machine |
| `marketplace_id` | object | No |  |
