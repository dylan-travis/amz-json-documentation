# EXERCISE_MAT Schema Documentation
...
| `sport_type[item].language_tag` | Required in sport_type[item] object |
| `sport_type[item].value` | Required in sport_type[item] object |
...
- `sport_type.value` - Required when `sport_type` is provided
- `sport_type.language_tag` - Required when `sport_type` is provided
...
| `sport_type` | array | Provide any specific sports with which the item is designed to be used |
| `league_name` | array | Name of league associated with this event |
| `team_name` | array | Provide the name of the sports team associated with the exercise mat, indicating the official branding or affiliation of the product. |
...
Provide any specific sports with which the item is designed to be used
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide any specific sports with which the item is designed to be used |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the exercise mat, indicating the official branding or affiliation of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the exercise mat, indicating the official branding or affiliation of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the length of the item when fully unfolded and ready for use. The length is measured head to toe. |
| `marketplace_id` | object | No |  |
| `thickness` | object | Yes | Provide the thickness of the item. |
| `width` | object | Yes | Provide the width of the item when fully unfolded and ready for use. The width is measured side to side. |

#### item_length_width_thickness[].length

Provide the length of the item when fully unfolded and ready for use. The length is measured head to toe.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item when fully unfolded and ready for use. The length is measured head to toe. |
| `unit` | string | Yes | Select the unit of measure for the item length. |

#### item_length_width_thickness[].thickness

Provide the thickness of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the thickness of the item. |
| `unit` | string | Yes | Select the unit of measure for the item thickness. |

#### item_length_width_thickness[].width

Provide the width of the item when fully unfolded and ready for use. The width is measured side to side.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item when fully unfolded and ready for use. The width is measured side to side. |
