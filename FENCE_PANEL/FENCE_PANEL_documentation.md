# FENCE_PANEL Schema Documentation
...
| `unit_count` | array | Provide the number of individual units that make up the item, indicating the total quantity. |
...
Provide the number of individual units that make up the item, indicating the total quantity.
