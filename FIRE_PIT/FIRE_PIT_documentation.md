...
| `fuel_type` | array | Provide the type of fuel the item burns, such as wood, gas, or other combustible materials that generate heat. |
...
| `item_depth_width_height` | array | Provide the dimensions of the item when ready for use, such as the size when fully assembled or unfolded. |
...
Provide the type of fuel the item burns, such as wood, gas, or other combustible materials that generate heat.
...
Provide the dimensions of the item when ready for use, such as the size when fully assembled or unfolded.
