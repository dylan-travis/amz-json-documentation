# FIRE_SCREEN Schema Documentation
...
| `team_name` | array | Provide the name of the sports team associated with the fire screen, representing the team's branding or logo on the product. |
...
Provide the name of the sports team associated with the fire screen, representing the team's branding or logo on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the fire screen, representing the team's branding or logo on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
