# FITNESS_BENCH Schema Documentation
...
|-----------|-------------|
| `adjustment_type[item].language_tag` | Required in adjustment_type[item] object |
| `adjustment_type[item].value` | Required in adjustment_type[item] object |
...
| `weight_bench_type[item].language_tag` | Required in weight_bench_type[item] object |
| `weight_bench_type[item].value` | Required in weight_bench_type[item] object |
...
- `adjustment_type.value` - Required when `adjustment_type` is provided
- `adjustment_type.language_tag` - Required when `adjustment_type` is provided
...
- `weight_bench_type.value` - Required when `weight_bench_type` is provided
- `weight_bench_type.language_tag` - Required when `weight_bench_type` is provided
...
| `adjustment_type` | array | Provide the item's adjustment type |
...
| `weight_bench_type` | array | Specify the type of the weight training bench |
| `weight_capacity` | array | The attribute indicates Weight Capacity of the product |
| `item_depth_width_height` | array | Provide the length, width, and height of the item when set up for use, such as fully unfolded or assembled. |
...
Provide the item's adjustment type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the item's adjustment type |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Specify the type of the weight training bench

**Type:** array

**Title:** Weight Bench Type

**Required:** No

**Examples:**

- `Flat, Adjustable, Folding, Abdominal`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of the weight training bench |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the length, width, and height of the item when set up for use, such as fully unfolded or assembled.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back when assembled and unexpanded. |
| `height` | object | Yes | Provide the height of the item from base to top when assembled and unexpanded. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width from side to side of the front of the item when fully assembled and unexpanded. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back when assembled and unexpanded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back when assembled and unexpanded. |
| `unit` | string | Yes | Select the unit of measure for the item depth. |

#### item_depth_width_height[].height

Provide the height of the item from base to top when assembled and unexpanded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from base to top when assembled and unexpanded. |
| `unit` | string | Yes | Select the unit of measure for the item height. |

#### item_depth_width_height[].width

Provide the width from side to side of the front of the item when fully assembled and unexpanded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width from side to side of the front of the item when fully assembled and unexpanded. |
