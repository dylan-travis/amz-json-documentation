...
| `compatible_vesa_mount_specifications[item].hole_pattern` | Required in compatible_vesa_mount_specifications[item] object |
| `compatible_vesa_mount_specifications[item].screen_weight` | Required in compatible_vesa_mount_specifications[item] object |
| `compatible_vesa_mount_specifications[item].screen_weight.unit` | Required in compatible_vesa_mount_specifications[item].screen_weight object |
| `compatible_vesa_mount_specifications[item].screen_weight.unit` | Required in compatible_vesa_mount_specifications[item].screen_weight object |
| `compatible_vesa_mount_specifications[item].screen_weight.value` | Required in compatible_vesa_mount_specifications[item].screen_weight object |
| `compatible_vesa_mount_specifications[item].screen_weight.value` | Required in compatible_vesa_mount_specifications[item].screen_weight object |
...
| `maximum_compatible_size[item].unit` | Required in maximum_compatible_size[item] object |
| `maximum_compatible_size[item].value` | Required in maximum_compatible_size[item] object |
...
| `minimum_compatible_size[item].unit` | Required in minimum_compatible_size[item] object |
| `minimum_compatible_size[item].value` | Required in minimum_compatible_size[item] object |
...
| `movement_type[item].language_tag` | Required in movement_type[item] object |
| `movement_type[item].value` | Required in movement_type[item] object |
...
**Title:** Minimum-Supported Screen Size
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | The smallest size supported by the item. |
...
**Title:** Maximum-Supported Screen Size
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | The largest size supported by the item. |
| `unit` | string | Yes | Select the corresponding unit |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of movement the product supports |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `hole_pattern` | string | Yes | Provide the VESA mount specifications  the item is compatible with. Vesa mount specifications are indicated as hole pattern and screen weight. |
| `marketplace_id` | object | No |  |
| `screen_weight` | object | Yes | Provide the maximum weight capacity that a VESA mount can support without being damaged. |

#### compatible_vesa_mount_specifications[].screen_weight

Provide the maximum weight capacity that a VESA mount can support without being damaged.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum weight capacity that a VESA mount can support without being damaged. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the maximum weight capacity that a compatible VESA mount can support without being damaged. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `cell_composition` | array | No | The chemical makeup of the battery |
