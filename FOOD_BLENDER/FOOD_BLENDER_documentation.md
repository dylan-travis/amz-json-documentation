# FOOD_BLENDER Schema Documentation
...
| `material_type_free` | array | Provide the materials or types of materials not used in making the item, like certain chemicals or ingredients. |
...
| `controls_type` | array | Provide the type of controls used to operate the item, buttons or knobs that adjust settings like speed and power. |
...
| `item_depth_width_height` | array | Provide the dimensions of the item when ready to use, such as the size it takes up when fully assembled or unfolded. |
...
Provide the materials or types of materials not used in making the item, like certain chemicals or ingredients.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials or types of materials that are specifically excluded from the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the type of controls used to operate the item, buttons or knobs that adjust settings like speed and power.
...
Provide the dimensions of the item when ready to use, such as the size it takes up when fully assembled or unfolded.
...
| `height` | object | Yes | Provide the height of the item from base to top including the jar when placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
...
Provide the height of the item from base to top including the jar when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from base to top including the jar when placed in the manner in which it is expected to be used. |
