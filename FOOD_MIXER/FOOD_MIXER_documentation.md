# FOOD_MIXER Schema Documentation
...
| `battery[item].weight[item].value` | Required in battery[item].weight[item] object |
| `blade[item].material[item].language_tag` | Required in blade[item].material[item] object |
| `blade[item].material[item].language_tag` | Required in blade[item].material[item] object |
| `blade[item].material[item].value` | Required in blade[item].material[item] object |
| `blade[item].material[item].value` | Required in blade[item].material[item] object |
...
| `container[item].material[item].language_tag` | Required in container[item].material[item] object |
| `container[item].material[item].language_tag` | Required in container[item].material[item] object |
| `container[item].material[item].value` | Required in container[item].material[item] object |
| `container[item].material[item].value` | Required in container[item].material[item] object |
| `control_method[item].value` | Required in control_method[item] object |
| `controls_type[item].language_tag` | Required in controls_type[item] object |
| `controls_type[item].value` | Required in controls_type[item] object |
...
| `number_of_speeds[item].value` | Required in number_of_speeds[item] object |
...
- `controls_type.value` - Required when `controls_type` is provided
- `controls_type.language_tag` - Required when `controls_type` is provided
...
- `number_of_speeds.value` - Required when `number_of_speeds` is provided
...
| `controls_type` | array | Provide the type of controls used to operate the item, such as buttons, knobs, or touch interface. |
| `flavor` | array | What flavor is the product? |
| `wattage` | array | Provide the item's wattage rating |
| `voltage` | array | Provide the electrical potential the item operates at, the force that drives its motor and functionality. |
...
| `blade` | array | The attribute indicates Blade of the product |
...
| `number_of_speeds` | array | Provide the number of speeds that the item offers |
| `control_method` | array | Provide the mechanism used to control the item for standard operations. |
| `item_depth_width_height` | array | Provide the dimensions of the item when ready to use, like when a rug is fully rolled out. |
...
Provide the type of controls used to operate the item, such as buttons, knobs, or touch interface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide a description of the item's controls. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the electrical potential the item operates at, the force that drives its motor and functionality.
...
The attribute indicates Blade of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Specify the type of material the blade is made of |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Specify the material of the container |
...
Provide the number of speeds that the item offers
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of speeds that the item offers |
| `marketplace_id` | object | No |  |
...
Provide the dimensions of the item when ready to use, like when a rug is fully rolled out.
