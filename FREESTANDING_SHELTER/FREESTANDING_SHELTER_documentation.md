# FREESTANDING_SHELTER Schema Documentation
...
| `occupancy[item].language_tag` | Required in occupancy[item] object |
| `occupancy[item].value` | Required in occupancy[item] object |
...
- `occupancy.value` - Required when `occupancy` is provided
- `occupancy.language_tag` - Required when `occupancy` is provided
...
| `team_name` | array | Provide the name of the sports team associated with the freestanding shelter, indicating the team branding or design theme of the product. |
...
| `occupancy` | array | Provide the maximum number of people the item can accommodate, its capacity or size, relevant for proper usage. |
| `floor_area` | array | Specify the area that the product occupies |
...
Provide the name of the sports team associated with the freestanding shelter, indicating the team branding or design theme of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the freestanding shelter, indicating the team branding or design theme of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum number of people the item can accommodate, its capacity or size, relevant for proper usage.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the maximum number of people the shelter can accommodate comfortably, indicating its size and capacity. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### floor_area

Specify the area that the product occupies
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item in ready to use condition when placed on a surface. The height is measured from top to bottom. |
...
Provide the height of the item in ready to use condition when placed on a surface. The height is measured from top to bottom.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item in ready to use condition when placed on a surface. The height is measured from top to bottom. |
