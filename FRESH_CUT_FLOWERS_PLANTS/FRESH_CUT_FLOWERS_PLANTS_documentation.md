# FRESH_CUT_FLOWERS_PLANTS Schema Documentation
...
| `plant_or_animal_product_type` | array | Specify the plant or animal product type |
...
| `occasion_type` | array | Provide the event or purpose the item is intended for, such as celebrations, holidays, or gifting occasions. |
...
Specify the plant or animal product type
...
Provide the event or purpose the item is intended for, such as celebrations, holidays, or gifting occasions.
