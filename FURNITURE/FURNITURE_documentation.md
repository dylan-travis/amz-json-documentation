# FURNITURE Schema Documentation
...
| `is_extendable[item].value` | Required in is_extendable[item] object |
| `is_fragile[item].value` | Required in is_fragile[item] object |
| `is_waterproof[item].language_tag` | Required in is_waterproof[item] object |
| `is_waterproof[item].value` | Required in is_waterproof[item] object |
...
- `is_waterproof.value` - Required when `is_waterproof` is provided
- `is_waterproof.language_tag` - Required when `is_waterproof` is provided
...
- `is_extendable.value` - Required when `is_extendable` is provided
...
| `is_waterproof` | array | Provide the is waterproof |
| `length_range` | array | Length range for blinds |
| `width_range` | array | Width range for blinds |
| `is_extendable` | array | Provide whether the table can be lengthened by adding extension leaves or panels to increase its seating capacity. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the is waterproof |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide whether the table can be lengthened by adding extension leaves or panels to increase its seating capacity.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the table can be lengthened by adding extension leaves or panels to increase its seating capacity. |
| `marketplace_id` | object | No |  |
