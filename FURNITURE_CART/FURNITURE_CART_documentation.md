# FURNITURE_CART Schema Documentation
...
| `shelf_dimensions[item].depth` | Required in shelf_dimensions[item] object |
| `shelf_dimensions[item].depth.unit` | Required in shelf_dimensions[item].depth object |
| `shelf_dimensions[item].depth.unit` | Required in shelf_dimensions[item].depth object |
| `shelf_dimensions[item].depth.value` | Required in shelf_dimensions[item].depth object |
| `shelf_dimensions[item].depth.value` | Required in shelf_dimensions[item].depth object |
| `shelf_dimensions[item].height` | Required in shelf_dimensions[item] object |
| `shelf_dimensions[item].height.unit` | Required in shelf_dimensions[item].height object |
| `shelf_dimensions[item].height.unit` | Required in shelf_dimensions[item].height object |
| `shelf_dimensions[item].height.value` | Required in shelf_dimensions[item].height object |
| `shelf_dimensions[item].height.value` | Required in shelf_dimensions[item].height object |
| `shelf_dimensions[item].width` | Required in shelf_dimensions[item] object |
| `shelf_dimensions[item].width.unit` | Required in shelf_dimensions[item].width object |
| `shelf_dimensions[item].width.unit` | Required in shelf_dimensions[item].width object |
| `shelf_dimensions[item].width.value` | Required in shelf_dimensions[item].width object |
| `shelf_dimensions[item].width.value` | Required in shelf_dimensions[item].width object |
...
- `shelf_dimensions.depth` - Required when `shelf_dimensions` is provided
- `shelf_dimensions.height` - Required when `shelf_dimensions` is provided
- `shelf_dimensions.width` - Required when `shelf_dimensions` is provided
...
| `shelf_type` | array | Provide the kind of shelves integrated into the cart, such as open or enclosed spaces for storage. |
...
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely hold without issues, the highest load it's designed to support. |
| `item_depth_width_height` | array | Provide the dimensions of the item when fully set up and ready for use, such as length, width, and height. |
...
| `shelf_dimensions` | array | Provide the depth, width, and height of the shelf on the item, the flat surface used for holding or displaying objects. |
...
Provide the kind of shelves integrated into the cart, such as open or enclosed spaces for storage.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of shelf the item has. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely hold without issues, the highest load it's designed to support.
...
Provide the dimensions of the item when fully set up and ready for use, such as length, width, and height.
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the furniture cart's clearance from the ground. |
| `marketplace_id` | object | No |  |

### shelf_dimensions

Provide the depth, width, and height of the shelf on the item, the flat surface used for holding or displaying objects.
...
- `Depth: 14 Inches, Width: 32 Inches, Height: 2 Inches`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the shelf included with the item. The depth is measured from front to back. |
| `height` | object | Yes | Provide the height of the shelf included with the item. The height is measured from bottom to top. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the shelf included with the item. The width is measured from side to side. |

#### shelf_dimensions[].depth

Provide the depth of the shelf included with the item. The depth is measured from front to back.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the shelf included with the item. The depth is measured from front to back. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the depth of the shelf included with the item. |

#### shelf_dimensions[].height

Provide the height of the shelf included with the item. The height is measured from bottom to top.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the shelf included with the item. The height is measured from bottom to top. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the height of the shelf included with the item. |

#### shelf_dimensions[].width

Provide the width of the shelf included with the item. The width is measured from side to side.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the shelf included with the item. The width is measured from side to side. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the width of the shelf included with the item. |
