...
| `is_artificial_garland[item].value` | Required in is_artificial_garland[item] object |
| `is_assembly_required[item].value` | Required in is_assembly_required[item] object |
| `is_lighted[item].value` | Required in is_lighted[item] object |
...
| `item_display_dimensions[item].width.value` | Required in item_display_dimensions[item].width object |
| `item_length[item].unit` | Required in item_length[item] object |
| `item_length[item].value` | Required in item_length[item] object |
...
| `light_source[item].operating_life[item].unit` | Required in light_source[item].operating_life[item] object |
| `light_source[item].operating_life[item].unit` | Required in light_source[item].operating_life[item] object |
| `light_source[item].operating_life[item].value` | Required in light_source[item].operating_life[item] object |
| `light_source[item].operating_life[item].value` | Required in light_source[item].operating_life[item] object |
...
- `item_length.value` - Required when `item_length` is provided
- `item_length.unit` - Required when `item_length` is provided
- `manufacture_year.value` - Required when `manufacture_year` is provided
- `is_lighted.value` - Required when `is_lighted` is provided
- `is_artificial_garland.value` - Required when `is_artificial_garland` is provided
...
| `plant_or_animal_product_type` | array | Provide the type of plant or animal material used in the garland, indicating the primary natural component of the decorative item. |
...
| `team_name` | array | Provide the name of the sports team associated with the garland, indicating the specific team the decorative item represents. |
...
| `item_length` | array | Provide the length of the item in ready to use condition. |
| `manufacture_year` | array | Provide the year the item was manufactured. |
| `is_lighted` | array | Provide whether the item contains or displays lights. |
| `is_artificial_garland` | array | Provide whether the item replicates an artificial garland. |
...
Provide the type of plant or animal material used in the garland, indicating the primary natural component of the decorative item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of plant or animal material used in the garland, indicating the primary natural component of the decorative item. |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the garland, indicating the specific team the decorative item represents.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the garland, indicating the specific team the decorative item represents. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `operating_life` | array | No | Provide the operating life of the light source |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the longer edge of the item when placed in the manner in which the product is expected to be used on the surface. |
...
Provide whether the item contains or displays lights.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the item contains or displays lights. |
| `marketplace_id` | object | No |  |

### is_artificial_garland

Provide whether the item replicates an artificial garland.

**Type:** array

**Title:** Is Artificial Garland
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the item replicates an artificial garland. |
| `marketplace_id` | object | No |  |
