# GREENHOUSE Schema Documentation
...
| `nominal_wall_thickness[item].language_tag` | Required in nominal_wall_thickness[item] object |
| `nominal_wall_thickness[item].value` | Required in nominal_wall_thickness[item] object |
...
| `number_of_vents[item].value` | Required in number_of_vents[item] object |
...
| `weight_capacity[item].maximum[item].value` | Required in weight_capacity[item].maximum[item] object |
| `weight_capacity[item].minimum[item].unit` | Required in weight_capacity[item].minimum[item] object |
| `weight_capacity[item].minimum[item].unit` | Required in weight_capacity[item].minimum[item] object |
| `weight_capacity[item].minimum[item].value` | Required in weight_capacity[item].minimum[item] object |
| `weight_capacity[item].minimum[item].value` | Required in weight_capacity[item].minimum[item] object |
...
- `number_of_vents.value` - Required when `number_of_vents` is provided
- `nominal_wall_thickness.value` - Required when `nominal_wall_thickness` is provided
- `nominal_wall_thickness.language_tag` - Required when `nominal_wall_thickness` is provided
...
| `number_of_vents` | array | Provide the number of vents in product |
| `weight_capacity` | array | Provide the maximum weight the item can safely hold without breaking or bending, indicating its strength and durability. |
| `nominal_wall_thickness` | array | Provide the nominal wall thickness |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `style` | array | No | Describe the style of the door |
...
Provide the number of vents in product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of vents in product |
| `marketplace_id` | object | No |  |

### weight_capacity

Provide the maximum weight the item can safely hold without breaking or bending, indicating its strength and durability.
...
| `minimum` | array | No | Provide the item's minimum weight capacity |

### nominal_wall_thickness

Provide the nominal wall thickness
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the nominal wall thickness |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Provide the primary way the item is closed or sealed, like zippers, buckles, or hooks that allow wearing or sealing it. |
