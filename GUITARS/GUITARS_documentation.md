...
| `back[item].material[item].language_tag` | Required in back[item].material[item] object |
| `back[item].material[item].language_tag` | Required in back[item].material[item] object |
| `back[item].material[item].value` | Required in back[item].material[item] object |
| `back[item].material[item].value` | Required in back[item].material[item] object |
...
| `battery[item].weight[item].value` | Required in battery[item].weight[item] object |
| `body[item].material[item].language_tag` | Required in body[item].material[item] object |
| `body[item].material[item].language_tag` | Required in body[item].material[item] object |
| `body[item].material[item].value` | Required in body[item].material[item] object |
| `body[item].material[item].value` | Required in body[item].material[item] object |
...
| `fretboard[item].material[item].language_tag` | Required in fretboard[item].material[item] object |
| `fretboard[item].material[item].language_tag` | Required in fretboard[item].material[item] object |
| `fretboard[item].material[item].value` | Required in fretboard[item].material[item] object |
| `fretboard[item].material[item].value` | Required in fretboard[item].material[item] object |
...
| `guitar_bridge_system[item].language_tag` | Required in guitar_bridge_system[item] object |
| `guitar_bridge_system[item].value` | Required in guitar_bridge_system[item] object |
| `guitar_pickup_configuration[item].language_tag` | Required in guitar_pickup_configuration[item] object |
| `guitar_pickup_configuration[item].value` | Required in guitar_pickup_configuration[item] object |
...
| `neck[item].material[item].language_tag` | Required in neck[item].material[item] object |
| `neck[item].material[item].language_tag` | Required in neck[item].material[item] object |
| `neck[item].material[item].value` | Required in neck[item].material[item] object |
| `neck[item].material[item].value` | Required in neck[item].material[item] object |
...
| `number_of_strings[item].value` | Required in number_of_strings[item] object |
...
| `scale_length[item].language_tag` | Required in scale_length[item] object |
| `scale_length[item].value` | Required in scale_length[item] object |
...
| `string[item].material[item].language_tag` | Required in string[item].material[item] object |
| `string[item].material[item].language_tag` | Required in string[item].material[item] object |
| `string[item].material[item].value` | Required in string[item].material[item] object |
| `string[item].material[item].value` | Required in string[item].material[item] object |
| `string_nut_width[item].unit` | Required in string_nut_width[item] object |
| `string_nut_width[item].value` | Required in string_nut_width[item] object |
...
- `number_of_strings.value` - Required when `number_of_strings` is provided
- `scale_length.value` - Required when `scale_length` is provided
- `scale_length.language_tag` - Required when `scale_length` is provided
...
- `guitar_bridge_system.value` - Required when `guitar_bridge_system` is provided
- `guitar_bridge_system.language_tag` - Required when `guitar_bridge_system` is provided
- `guitar_pickup_configuration.value` - Required when `guitar_pickup_configuration` is provided
- `guitar_pickup_configuration.language_tag` - Required when `guitar_pickup_configuration` is provided
...
- `string_nut_width.value` - Required when `string_nut_width` is provided
- `string_nut_width.unit` - Required when `string_nut_width` is provided
...
| `size` | array | Instrument size attributed to orchestral instruments |
...
| `number_of_strings` | array | Describes the number of strings on the instrument. |
| `scale_length` | array | Provide the length of the scale. |
...
| `guitar_bridge_system` | array | Provide the type of bridge system on the guitar, indicating whether it has a fixed or tremolo-style bridge for string tension adjustment. |
| `guitar_pickup_configuration` | array | Describes the pickup configurations of a guitar |
...
| `hand_orientation` | array | Provide the dominant hand the item is designed for, indicating whether it's for right or left-handed players. |
| `back` | array | The attribute indicates Back of the product |
| `body` | array | The attribute indicates Body of the product |
| `fretboard` | array | The attribute indicates Fretboard of the product |
| `neck` | array | The attribute indicates Neck of the product |
| `string` | array | The attribute indicates String of the product |
...
| `string_nut_width` | array | Provide the width of the string nut. String nut width refers to the width of the instrument's neck closest to the headstock or scroll. |
...
Instrument size attributed to orchestral instruments
...
Describes the number of strings on the instrument.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the quantity of strings on the guitar, indicating the instrument's configuration and playing capabilities. |
| `marketplace_id` | object | No |  |

### scale_length

Provide the length of the scale.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the length of the scale. |
| `unit` | string | No | Provide the scale length unit. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the type of bridge system on the guitar, indicating whether it has a fixed or tremolo-style bridge for string tension adjustment.

**Type:** array

**Title:** Guitar Bridge System
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of bridge system on the guitar, indicating whether it has a fixed or tremolo-style bridge for string tension adjustment. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### guitar_pickup_configuration

Describes the pickup configurations of a guitar

**Type:** array

**Title:** Guitar Pickup Configuration

**Required:** No

**Examples:**

- `Piezoelectric, Magnetic Single Coil Pickups`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the arrangement of pickups on the guitar, indicating how it captures and converts string vibrations into electrical signals. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the dominant hand the item is designed for, indicating whether it's for right or left-handed players.
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the back of the item, the solid body or hollow section that supports the strings. |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the body of the item, the main structure that produces sound. |

### fretboard

The attribute indicates Fretboard of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the fretboard on the item, the long strip where fingers press the strings. |

### neck

The attribute indicates Neck of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the neck of the item, the part that holds the strings and frets. |

### string

The attribute indicates String of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material of the string |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item from the surface to top when placed in the manner in which it is expected to be used. |
| `length` | object | Yes | Provide the length of the item using the longer edge. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item using shorter edge. |

#### item_length_width_height[].height

Provide the height of the item from the surface to top when placed in the manner in which it is expected to be used.

**Type:** object

**Title:** Item Height Surface To Top
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from the surface to top when placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s height. |

#### item_length_width_height[].length

Provide the length of the item using the longer edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item using the longer edge. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s length. |

#### item_length_width_height[].width

Provide the width of the item using shorter edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item using shorter edge. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s width. |

### string_nut_width

Provide the width of the string nut. String nut width refers to the width of the instrument's neck closest to the headstock or scroll.

**Type:** array

**Title:** String Nut Width
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the string nut. String nut width refers to the width of the instrument's neck closest to the headstock or scroll. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's string nut width. |
| `marketplace_id` | object | No |  |
