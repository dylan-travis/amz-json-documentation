...
| `folded_size[item].language_tag` | Required in folded_size[item] object |
| `folded_size[item].value` | Required in folded_size[item] object |
...
- `folded_size.value` - Required when `folded_size` is provided
- `folded_size.language_tag` - Required when `folded_size` is provided
...
| `fabric_type` | array | Provide the materials used in the hammock's construction, including percentages of each fabric type. |
...
| `folded_size` | array | Provide the size of the item when folded into its most compact state, typically measured in inches or centimeters. |
...
| `team_name` | array | Provide the name of the sports team associated with the hammock, indicating the team-themed design or branding on the product. |
...
Provide the materials used in the hammock's construction, including percentages of each fabric type.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials used in the hammock's construction, including percentages of each fabric type. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the size of the item when folded into its most compact state, typically measured in inches or centimeters.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the size of the item when folded into its most compact state, typically measured in inches or centimeters. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the hammock, indicating the team-themed design or branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the hammock, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the length of the item using the longer edge when assembled. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item using the shorter edge when assembled. |

#### item_length_width[].length

Provide the length of the item using the longer edge when assembled.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item using the longer edge when assembled. |
| `unit` | string | Yes | Select the unit of measure for the item depth. |

#### item_length_width[].width

Provide the width of the item using the shorter edge when assembled.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item using the shorter edge when assembled. |
