# HANGING_ORNAMENT Schema Documentation
...
| `is_bulk_pack[item].value` | Required in is_bulk_pack[item] object |
...
| `year_represented[item].value` | Required in year_represented[item] object |
...
- `is_bulk_pack.value` - Required when `is_bulk_pack` is provided
- `year_represented.value` - Required when `year_represented` is provided
...
| `subject_character` | array | Provide the main character, figure or theme depicted by the item, representing a person, animal or concept. |
...
| `occasion_type` | array | Provide the occasion that the item is designed for. Occasion types include holidays and major life events. |
...
| `mounting_type` | array | Provide the way the item is designed to be hung or attached, how it can be mounted or suspended from another object. |
| `item_form` | array | Provide a value that represents the form of the item |
| `unit_count` | array | Provide the total number and type of units included in the item, indicating the quantity and measurement. |
...
| `league_name` | array | Provide the league or organization the item represents or is associated with, indicating its theme or design inspiration. |
| `team_name` | array | Provide the name of the sports team represented on the item, identifying the group or organization it represents. |
...
| `animal_theme` | array | Provide the animal that is either printed on the product or the product is shaped as. |
| `item_depth_width_height` | array | Provide the dimensions of the item when ready for display, its depth, width, and height when fully assembled or unfolded. |
| `is_bulk_pack` | array | Provide whether the item is a bulk pack with a higher quantity. |
| `year_represented` | array | Provide the year that is displayed on or represented by the decorative item. |
...
| `num_batteries` | array | Provide the number and type of batteries needed to power the item, required for operation. |
...
Provide the main character, figure or theme depicted by the item, representing a person, animal or concept.
...
Provide the occasion that the item is designed for. Occasion types include holidays and major life events.
...
Provide the way the item is designed to be hung or attached, how it can be mounted or suspended from another object.
...
Provide the total number and type of units included in the item, indicating the quantity and measurement.
...
Provide the league or organization the item represents or is associated with, indicating its theme or design inspiration.
...
Provide the name of the sports team represented on the item, identifying the group or organization it represents.
...
Provide the animal that is either printed on the product or the product is shaped as.
...
Provide the dimensions of the item when ready for display, its depth, width, and height when fully assembled or unfolded.
...
Provide whether the item is a bulk pack with a higher quantity.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the item is a bulk pack with a higher quantity. |
| `marketplace_id` | object | No |  |

### year_represented

Provide the year that is displayed on or represented by the decorative item.

**Type:** array

**Title:** Year Represented
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the year that is displayed on or represented by the decorative item. |
| `marketplace_id` | object | No |  |
...
Provide the number and type of batteries needed to power the item, required for operation.
