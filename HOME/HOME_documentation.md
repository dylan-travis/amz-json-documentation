...
| `closure[item].type[item].value` | Required in closure[item].type[item] object |
| `collection_description[item].language_tag` | Required in collection_description[item] object |
| `collection_description[item].value` | Required in collection_description[item] object |
...
| `limited_edition_range[item].language_tag` | Required in limited_edition_range[item] object |
| `limited_edition_range[item].value` | Required in limited_edition_range[item] object |
...
- `collection_description.value` - Required when `collection_description` is provided
- `collection_description.language_tag` - Required when `collection_description` is provided
...
- `limited_edition_range.value` - Required when `limited_edition_range` is provided
- `limited_edition_range.language_tag` - Required when `limited_edition_range` is provided
...
| `collection_description` | array | Collection Description |
...
| `operating_system` | array | Provide the operating system software installed on the item, which manages hardware and software resources and offers common services for computer programs. |
...
| `limited_edition_range` | array | The overall edition range. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Collection Description |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the operating system software installed on the item, which manages hardware and software resources and offers common services for computer programs.
...
### limited_edition_range

The overall edition range.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | The overall edition range. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
