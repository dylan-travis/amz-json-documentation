...
| `has_smart_features[item].value` | Required in has_smart_features[item] object |
...
| `is_hanging[item].value` | Required in is_hanging[item] object |
...
| `magnification_strength[item].unit` | Required in magnification_strength[item] object |
| `magnification_strength[item].value` | Required in magnification_strength[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the magnification strength of the item |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of surface the mirror is designed to be used on, indicating its intended placement in a home setting. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the mirror is designed to be attached or positioned for use in a home setting. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the sports team name associated with the mirror, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the mirror is designed for, indicating its intended use and suitable location in a home. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the animal printed on or shaping the mirror, representing a decorative element or design feature of the home mirror. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the measurement of the length of the item in ready to use condition.  Length is the vertical measurement (top to bottom) in and upright  or standing position. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the measurement of the width measured side to side of the item in ready to use condition. |

#### item_length_width[].length

Provide the measurement of the length of the item in ready to use condition.  Length is the vertical measurement (top to bottom) in and upright  or standing position.

**Type:** object

**Title:** Item Length Top to Bottom
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the length of the item in ready to use condition.  Length is the vertical measurement (top to bottom) in and upright  or standing position. |
| `unit` | string | Yes | Select the unit of measure for Item length. |

#### item_length_width[].width

Provide the measurement of the width measured side to side of the item in ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the width measured side to side of the item in ready to use condition. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the product has integrated smart features that provide connectivity and additional functionality. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the item is designed to hang on a wall, door or other vertical surface. |
| `marketplace_id` | object | No |  |
