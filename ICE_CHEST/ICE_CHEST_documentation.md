# ICE_CHEST Schema Documentation
...
| `chamber[item].depth[item].language_tag` | Required in chamber[item].depth[item] object |
| `chamber[item].depth[item].language_tag` | Required in chamber[item].depth[item] object |
| `chamber[item].depth[item].unit` | Required in chamber[item].depth[item] object |
| `chamber[item].depth[item].unit` | Required in chamber[item].depth[item] object |
| `chamber[item].depth[item].value` | Required in chamber[item].depth[item] object |
| `chamber[item].depth[item].value` | Required in chamber[item].depth[item] object |
| `chamber[item].height[item].language_tag` | Required in chamber[item].height[item] object |
| `chamber[item].height[item].language_tag` | Required in chamber[item].height[item] object |
| `chamber[item].height[item].value` | Required in chamber[item].height[item] object |
| `chamber[item].height[item].value` | Required in chamber[item].height[item] object |
| `chamber[item].width[item].language_tag` | Required in chamber[item].width[item] object |
| `chamber[item].width[item].language_tag` | Required in chamber[item].width[item] object |
| `chamber[item].width[item].value` | Required in chamber[item].width[item] object |
| `chamber[item].width[item].value` | Required in chamber[item].width[item] object |
...
| `insulation[item].material[item].language_tag` | Required in insulation[item].material[item] object |
| `insulation[item].material[item].language_tag` | Required in insulation[item].material[item] object |
| `insulation[item].material[item].value` | Required in insulation[item].material[item] object |
| `insulation[item].material[item].value` | Required in insulation[item].material[item] object |
...
| `lens[item].color[item].value` | Required in lens[item].color[item] object |
| `line_weight[item].language_tag` | Required in line_weight[item] object |
| `line_weight[item].value` | Required in line_weight[item] object |
...
| `shell_type` | array | Provide the material used to construct the outer body of the item, which provides insulation and protection. |
...
| `team_name` | array | Provide the name of the sports team or organization associated with the item, representing their brand or affiliation. |
...
| `chamber` | array | The attribute indicates Chamber of the product |
...
| `item_depth_width_height` | array | Provide the dimensions of the item when ready to use, like the length, width, and height of a fully unfolded blanket. |
...
Provide the material used to construct the outer body of the item, which provides insulation and protection.
...
Provide the name of the sports team or organization associated with the item, representing their brand or affiliation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the ice chest, indicating the team-specific design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Chamber of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | array | No | Enter the depth of the used chamber. Do not include modifier. |
| `height` | array | No | Provide the height of the inside space of the item, the measurement from top to bottom of the storage area. |
| `marketplace_id` | object | No |  |
| `width` | array | No | Provide the width of the chamber |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Provide the type of insulated container the item is, used to keep food and drinks cool with ice or ice packs. |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the products insulation material type |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the fishing line weight with the appropriate unit |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### item_depth_width_height

Provide the dimensions of the item when ready to use, like the length, width, and height of a fully unfolded blanket.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back when placed in the manner in which it is expected to be used. Include the stands, trolley or wheel when these are part of the item. |
| `height` | object | Yes | Provide the height of the item from top to bottom when placed in the manner in which it is expected to be used. Include stands, trolley or wheel when part of the item. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side when placed in the manner it is expected to be used. Including stands, trolley or wheel when these are part of the item. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back when placed in the manner in which it is expected to be used. Include the stands, trolley or wheel when these are part of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back when placed in the manner in which it is expected to be used. Include the stands, trolley or wheel when these are part of the item. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s depth. |

#### item_depth_width_height[].height

Provide the height of the item from top to bottom when placed in the manner in which it is expected to be used. Include stands, trolley or wheel when part of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from top to bottom when placed in the manner in which it is expected to be used. Include stands, trolley or wheel when part of the item. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s height. |

#### item_depth_width_height[].width

Provide the width of the item from side to side when placed in the manner it is expected to be used. Including stands, trolley or wheel when these are part of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item from side to side when placed in the manner it is expected to be used. Including stands, trolley or wheel when these are part of the item. |
