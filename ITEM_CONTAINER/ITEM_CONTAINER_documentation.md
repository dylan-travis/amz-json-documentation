# ITEM_CONTAINER Schema Documentation
...
| `unit_count` | array | Provide the number and type of individual units the item contains, indicating its capacity or quantity. |
...
| `team_name` | array | Provide the name of the sports team associated with the container, indicating the team affiliation or branding of the product. |
...
Provide the number and type of individual units the item contains, indicating its capacity or quantity.
...
Provide the name of the sports team associated with the container, indicating the team affiliation or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the container, indicating the team affiliation or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item when placed in the manner in which it is expected to be used. The height is measured from base to top when placed on surface. |
| `length` | object | Yes | Provide the length of the item using the longer edge. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide length of the item using the shorter edge. |

#### item_length_width_height[].height

Provide the height of the item when placed in the manner in which it is expected to be used. The height is measured from base to top when placed on surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item when placed in the manner in which it is expected to be used. The height is measured from base to top when placed on surface. |
...
Provide length of the item using the shorter edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide length of the item using the shorter edge. |
