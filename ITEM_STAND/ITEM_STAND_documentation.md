# ITEM_STAND Schema Documentation
...
| `number_of_levels` | array | Provide the number of separate surfaces the item has to hold objects, indicating its vertical capacity. |
...
Provide the number of separate surfaces the item has to hold objects, indicating its vertical capacity.
