# JEWELRY_STORAGE Schema Documentation
...
| `denomination[item].value` | Required in denomination[item] object |
...
| `jewelry_storage_type[item].value` | Required in jewelry_storage_type[item] object |
...
| `lens[item].width[item].language_tag` | Required in lens[item].width[item] object |
| `lens[item].width[item].language_tag` | Required in lens[item].width[item] object |
| `lens[item].width[item].value` | Required in lens[item].width[item] object |
| `lens[item].width[item].value` | Required in lens[item].width[item] object |
...
| `total_diamond_weight[item].value` | Required in total_diamond_weight[item] object |
...
- `total_diamond_weight.value` - Required when `total_diamond_weight` is provided
...
- `jewelry_storage_type.value` - Required when `jewelry_storage_type` is provided
...
| `total_diamond_weight` | array | Provide the total diamond weight |
| `occasion_type` | array | Provide the holiday or major life event that the jewelry storage item is designed for, such as anniversaries or weddings. |
...
| `mounting_type` | array | Provide the type of mount the jewelry storage item has or is intended for, indicating how it can be attached or positioned. |
...
| `team_name` | array | Provide the name of the sports team associated with the jewelry storage item, indicating the team-themed design or branding. |
...
| `jewelry_storage_type` | array | Provide the specific form and function of the jewelry storage item, such as a box, chest, armoire, or stand. |
...
Provide the total diamond weight

**Type:** array

**Title:** Total Diamond Weight
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the total diamond weight |
| `unit` | string | No | Provide the relevant unit |
| `marketplace_id` | object | No |  |

### occasion_type

Provide the holiday or major life event that the jewelry storage item is designed for, such as anniversaries or weddings.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event that the jewelry storage item is designed for, such as anniversaries or weddings. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Currency amount of the gift card |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `width` | array | No | Enter the lens width. |
...
Provide the type of mount the jewelry storage item has or is intended for, indicating how it can be attached or positioned.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of mount the jewelry storage item has or is intended for, indicating how it can be attached or positioned. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the jewelry storage item, indicating the team-themed design or branding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the jewelry storage item, indicating the team-themed design or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
### jewelry_storage_type

Provide the specific form and function of the jewelry storage item, such as a box, chest, armoire, or stand.

**Type:** array

**Title:** Jewelry Storage Type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific form and function of the jewelry storage item, such as a box, chest, armoire, or stand. |
| `marketplace_id` | object | No |  |
