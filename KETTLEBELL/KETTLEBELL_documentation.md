# KETTLEBELL Schema Documentation
...
| `grip[item].size[item].value` | Required in grip[item].size[item] object |
| `handle[item].diameter[item].language_tag` | Required in handle[item].diameter[item] object |
| `handle[item].diameter[item].language_tag` | Required in handle[item].diameter[item] object |
| `handle[item].diameter[item].value` | Required in handle[item].diameter[item] object |
| `handle[item].diameter[item].value` | Required in handle[item].diameter[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `diameter` | array | No | Provide the diameter of the handle |
| `marketplace_id` | object | No |  |
