...
| `contains_liquid_contents[item].value` | Required in contains_liquid_contents[item] object |
...
| `liquid_volume[item].value` | Required in liquid_volume[item] object |
...
| `media_type[item].language_tag` | Required in media_type[item] object |
| `media_type[item].value` | Required in media_type[item] object |
...
| `pore_size[item].unit` | Required in pore_size[item] object |
| `pore_size[item].value` | Required in pore_size[item] object |
...
| `service_plan[item].covered_value[item].language_tag` | Required in service_plan[item].covered_value[item] object |
| `service_plan[item].covered_value[item].language_tag` | Required in service_plan[item].covered_value[item] object |
| `service_plan[item].covered_value[item].value` | Required in service_plan[item].covered_value[item] object |
| `service_plan[item].covered_value[item].value` | Required in service_plan[item].covered_value[item] object |
| `service_plan[item].term[item].language_tag` | Required in service_plan[item].term[item] object |
| `service_plan[item].term[item].language_tag` | Required in service_plan[item].term[item] object |
| `service_plan[item].term[item].value` | Required in service_plan[item].term[item] object |
| `service_plan[item].term[item].value` | Required in service_plan[item].term[item] object |
...
| `total_gem_weight[item].value` | Required in total_gem_weight[item] object |
| `total_metal_weight[item].unit` | Required in total_metal_weight[item] object |
| `total_metal_weight[item].value` | Required in total_metal_weight[item] object |
...
| `weight_range[item].language_tag` | Required in weight_range[item] object |
| `weight_range[item].value` | Required in weight_range[item] object |
...
- `pore_size.value` - Required when `pore_size` is provided
- `pore_size.unit` - Required when `pore_size` is provided
- `capacity.value` - Required when `capacity` is provided
- `capacity.unit` - Required when `capacity` is provided
- `media_type.value` - Required when `media_type` is provided
- `media_type.language_tag` - Required when `media_type` is provided
...
- `total_gem_weight.value` - Required when `total_gem_weight` is provided
- `total_metal_weight.value` - Required when `total_metal_weight` is provided
- `total_metal_weight.unit` - Required when `total_metal_weight` is provided
- `weight_range.value` - Required when `weight_range` is provided
- `weight_range.language_tag` - Required when `weight_range` is provided
...
- `contains_liquid_contents.value` - Required when `contains_liquid_contents` is provided
- `liquid_volume.value` - Required when `liquid_volume` is provided
...
| `pore_size` | array | Provide the pore size. |
| `capacity` | array | The capacity of the item. |
| `media_type` | array | Specify the type of media the product is or supports |
...
| `service_plan` | array | The attribute indicates Service Plan of the product |
| `waist` | array | The attribute indicates Waist of the product |
| `width_range` | array | Width range for blinds |
| `total_gem_weight` | array | Provide the total gem weight |
| `total_metal_weight` | array | Provide the total metal weight |
| `weight_range` | array | weight a product can hold |
...
| `contains_liquid_contents` | array | Does the product contain liquid contents? |
| `liquid_volume` | array | Provide the item's liquid volume |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the size of the pore |
...
Specify the type of media the product is or supports
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of media the product is or supports |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Service Plan of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `covered_value` | array | No | Text value |
| `marketplace_id` | object | No |  |
| `term` | array | No | Text value |
...
Provide the total gem weight

**Type:** array

**Title:** Total Gem Weight
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the total gem weight |
| `unit` | string | No | Provide the relevant unit |
| `marketplace_id` | object | No |  |

### total_metal_weight

Provide the total metal weight
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the total metal weight |
| `unit` | string | Yes | Provide the relevant unit |
| `marketplace_id` | object | No |  |

### weight_range

weight a product can hold
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | weight a product can hold |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Does the product contain liquid contents? |
| `marketplace_id` | object | No |  |

### liquid_volume

Provide the item's liquid volume
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the liquid volume as a numeric value. |
| `unit` | string | No | Select the unit of measure for Liquid  Volume. If a value is provided for Item Volume, you must also enter the corresponding unit. |
| `marketplace_id` | object | No |  |
