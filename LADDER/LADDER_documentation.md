...
| `number_of_steps[item].value` | Required in number_of_steps[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this ladder apart from similar products, enhancing its functionality or appeal. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the ladder, indicating the team branding or affiliation of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item from top to bottom when fully extended. |
| `marketplace_id` | object | No |  |
...
Provide the height of the item from top to bottom when fully extended.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from top to bottom when fully extended. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the total number of steps, that this product has. A step, or rung, allows users to climb the product. |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the ladder's maximum height or supported height. |
| `marketplace_id` | object | No |  |
