# LAUNDRY_HAMPER Schema Documentation
...
| `special_feature` | array | Provide the unique characteristics that set this laundry hamper apart from similar products, enhancing its functionality or design. |
| `style` | array | The style of the item |
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the intended user group based on age. |
...
| `subject_character` | array | Provide the main character represented by the laundry hamper, indicating the design or theme of the item. |
...
| `theme` | array | Provide the main idea or concept the item represents through its design or imagery, like a nautical theme with boats and anchors. |
...
| `mounting_type` | array | Provide the type of mount the laundry hamper has or is intended for, indicating how it can be attached or secured in place. |
...
| `team_name` | array | Provide the name of the sports team associated with the laundry hamper, indicating the team-themed design or branding on the product. |
...
| `room_type` | array | Provide the intended room for the laundry hamper, indicating where it is designed to be used or placed within a home. |
...
Provide the unique characteristics that set this laundry hamper apart from similar products, enhancing its functionality or design.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this laundry hamper apart from similar products, enhancing its functionality or design. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the age range the item is suitable for, indicating the intended user group based on age.
...
Provide the main character represented by the laundry hamper, indicating the design or theme of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the laundry hamper, indicating the design or theme of the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main idea or concept the item represents through its design or imagery, like a nautical theme with boats and anchors.
...
Provide the type of mount the laundry hamper has or is intended for, indicating how it can be attached or secured in place.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of mount the laundry hamper has or is intended for, indicating how it can be attached or secured in place. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the laundry hamper, indicating the team-themed design or branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the laundry hamper, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the intended room for the laundry hamper, indicating where it is designed to be used or placed within a home.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended room for the laundry hamper, indicating where it is designed to be used or placed within a home. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
