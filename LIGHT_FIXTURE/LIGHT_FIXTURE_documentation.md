...
| `connectivity_protocol[item].language_tag` | Required in connectivity_protocol[item] object |
| `connectivity_protocol[item].value` | Required in connectivity_protocol[item] object |
...
| `dial[item].color[item].value` | Required in dial[item].color[item] object |
| `display[item].size[item].value` | Required in display[item].size[item] object |
| `display[item].size[item].value` | Required in display[item].size[item] object |
...
| `fixture_type[item].language_tag` | Required in fixture_type[item] object |
| `fixture_type[item].value` | Required in fixture_type[item] object |
...
| `installation_type[item].language_tag` | Required in installation_type[item] object |
| `installation_type[item].value` | Required in installation_type[item] object |
...
| `light_fixture_form[item].value` | Required in light_fixture_form[item] object |
...
| `light_source[item].type[item].value` | Required in light_source[item].type[item] object |
| `lighting_method[item].language_tag` | Required in lighting_method[item] object |
| `lighting_method[item].value` | Required in lighting_method[item] object |
...
| `shade[item].color[item].language_tag` | Required in shade[item].color[item] object |
| `shade[item].color[item].language_tag` | Required in shade[item].color[item] object |
| `shade[item].color[item].value` | Required in shade[item].color[item] object |
| `shade[item].color[item].value` | Required in shade[item].color[item] object |
...
| `switch_type[item].language_tag` | Required in switch_type[item] object |
| `switch_type[item].value` | Required in switch_type[item] object |
...
| `voltage[item].unit` | Required in voltage[item] object |
...
| `wattage[item].unit` | Required in wattage[item] object |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | Provide the diagonal screen size measurement of the display in inches. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | The attribute indicates the Fixture Type of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the product's lighting method |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Select the unit of measure for Wattage. If a value is provided for Wattage, you must also enter the corresponding unit. |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Select the unit of measure for Voltage. If a value is provided for Voltage, you must also enter the corresponding unit. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of installation the item requires |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the product's mounting type. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of switch that the item has |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the product's connectivity protocol |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the type of controller that the item has |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Description of something extra attached to the item for decorative purposes. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Provide the type of light source the item uses, such as bulb, LED, or fluorescent, which determines its brightness and energy use. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the product is intended for. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `color` | array | No | Specify the color of the shade |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item measured from base to top when assembled and unexpanded. |
| `length` | object | Yes | Provide the length of the item measured at the longer horizontal edge assembled and placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
...
Provide the height of the item measured from base to top when assembled and unexpanded.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item measured from base to top when assembled and unexpanded. |
| `unit` | string | Yes | Provide the unit of measure for the item height. |

#### item_length_width_height[].length

Provide the length of the item measured at the longer horizontal edge assembled and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item measured at the longer horizontal edge assembled and placed in the manner in which it is expected to be used. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the form type of the light fixture. The form type describes the overall shape and physical design of the light fixture. |
| `marketplace_id` | object | No |  |
