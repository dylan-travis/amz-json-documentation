# LITTER_BOX Schema Documentation
...
| `lithium_battery[item].weight[item].value` | Required in lithium_battery[item].weight[item] object |
| `litter_box_type[item].value` | Required in litter_box_type[item] object |
...
- `litter_box_type.value` - Required when `litter_box_type` is provided
...
| `litter_box_type` | array | Provide the specific type of litter box. Litter boxes are primarily defined by a combination of form, function, and reusability. |
...
Provide the specific type of litter box. Litter boxes are primarily defined by a combination of form, function, and reusability.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific type of litter box. Litter boxes are primarily defined by a combination of form, function, and reusability. |
| `marketplace_id` | object | No |  |
