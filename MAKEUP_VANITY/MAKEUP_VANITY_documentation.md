# MAKEUP_VANITY Schema Documentation
...
| `mirror_dimensions[item].length` | Required in mirror_dimensions[item] object |
| `mirror_dimensions[item].length.unit` | Required in mirror_dimensions[item].length object |
| `mirror_dimensions[item].length.unit` | Required in mirror_dimensions[item].length object |
| `mirror_dimensions[item].length.value` | Required in mirror_dimensions[item].length object |
| `mirror_dimensions[item].length.value` | Required in mirror_dimensions[item].length object |
| `mirror_dimensions[item].width` | Required in mirror_dimensions[item] object |
| `mirror_dimensions[item].width.unit` | Required in mirror_dimensions[item].width object |
| `mirror_dimensions[item].width.unit` | Required in mirror_dimensions[item].width object |
| `mirror_dimensions[item].width.value` | Required in mirror_dimensions[item].width object |
| `mirror_dimensions[item].width.value` | Required in mirror_dimensions[item].width object |
...
- `mirror_dimensions.length` - Required when `mirror_dimensions` is provided
- `mirror_dimensions.width` - Required when `mirror_dimensions` is provided
...
| `mirror_dimensions` | array | Provide the dimensions of the mirror included with the item. Mirror dimensions describes the length and width of item's mirror. |
...
Provide the dimensions of the mirror included with the item. Mirror dimensions describes the length and width of item's mirror.
...
- `Length: 23.6 Inches, Width: 20 Inches`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the length of the mirror included with the item. The length is the measure of the longer edge of the mirror. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the mirror included with the item. The width is the measure of the shorter edge of the mirror. |

#### mirror_dimensions[].length

Provide the length of the mirror included with the item. The length is the measure of the longer edge of the mirror.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the mirror included with the item. The length is the measure of the longer edge of the mirror. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the length of the mirror included with the item. |

#### mirror_dimensions[].width

Provide the width of the mirror included with the item. The width is the measure of the shorter edge of the mirror.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the mirror included with the item. The width is the measure of the shorter edge of the mirror. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the width of the mirror included with the item. |
