# MARBLE_TRACK Schema Documentation
...
| `age_range_description` | array | Provide the recommended ages for using the item, explaining who it is suitable for based on skills and interests. |
...
| `sub_brand` | array | Provide the additional brand or franchise associated with the item, such as licensed characters or themes. |
...
Provide the recommended ages for using the item, explaining who it is suitable for based on skills and interests.
...
Provide the additional brand or franchise associated with the item, such as licensed characters or themes.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the product's educational objective |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
