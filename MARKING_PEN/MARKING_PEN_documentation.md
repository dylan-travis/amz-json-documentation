...
| `body[item].shape[item].language_tag` | Required in body[item].shape[item] object |
| `body[item].shape[item].language_tag` | Required in body[item].shape[item] object |
| `body[item].shape[item].value` | Required in body[item].shape[item] object |
| `body[item].shape[item].value` | Required in body[item].shape[item] object |
...
| `ink[item].base[item].value` | Required in ink[item].base[item] object |
| `ink[item].base[item].value` | Required in ink[item].base[item] object |
...
| `marker_type[item].value` | Required in marker_type[item] object |
...
| `point[item].type[item].language_tag` | Required in point[item].type[item] object |
| `point[item].type[item].language_tag` | Required in point[item].type[item] object |
| `point[item].type[item].value` | Required in point[item].type[item] object |
| `point[item].type[item].value` | Required in point[item].type[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Describe the surface that the item is recommended for |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the writing instrument's line/point size |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `shape` | array | No | Provide the products body shape |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `base` | array | No | Provide the main liquid material the item's ink is made of, like water, oil or alcohol, which affects its properties. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of marker or marking pen. This is primarily distinguished by the specific intended use of the marker or pen. |
| `marketplace_id` | object | No |  |
