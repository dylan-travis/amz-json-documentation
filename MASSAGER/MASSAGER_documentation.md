...
| `directions[item].language_tag` | Required in directions[item] object |
| `directions[item].value` | Required in directions[item] object |
...
| `fc_shelf_life[item].unit` | Required in fc_shelf_life[item] object |
| `fc_shelf_life[item].value` | Required in fc_shelf_life[item] object |
...
| `is_cordless[item].value` | Required in is_cordless[item] object |
| `is_expiration_dated_product[item].value` | Required in is_expiration_dated_product[item] object |
| `is_heat_sensitive[item].value` | Required in is_heat_sensitive[item] object |
...
| `labeler_name[item].language_tag` | Required in labeler_name[item] object |
| `labeler_name[item].value` | Required in labeler_name[item] object |
...
| `massage_therapy_technique[item].value` | Required in massage_therapy_technique[item] object |
| `massager_form[item].value` | Required in massager_form[item] object |
...
| `maximum_circumference[item].unit` | Required in maximum_circumference[item] object |
| `maximum_circumference[item].value` | Required in maximum_circumference[item] object |
...
| `product_benefit[item].language_tag` | Required in product_benefit[item] object |
| `product_benefit[item].value` | Required in product_benefit[item] object |
...
| `product_expiration_type[item].language_tag` | Required in product_expiration_type[item] object |
| `product_expiration_type[item].value` | Required in product_expiration_type[item] object |
...
| `runtime[item].value` | Required in runtime[item] object |
...
| `target_use_body_part[item].value` | Required in target_use_body_part[item] object |
| `team_name[item].language_tag` | Required in team_name[item] object |
| `team_name[item].value` | Required in team_name[item] object |
| `unit_count[item].type` | Required in unit_count[item] object |
...
- `runtime.value` - Required when `runtime` is provided
...
- `is_heat_sensitive.value` - Required when `is_heat_sensitive` is provided
...
- `maximum_circumference.value` - Required when `maximum_circumference` is provided
- `maximum_circumference.unit` - Required when `maximum_circumference` is provided
...
- `labeler_name.value` - Required when `labeler_name` is provided
- `labeler_name.language_tag` - Required when `labeler_name` is provided
- `target_use_body_part.value` - Required when `target_use_body_part` is provided
- `is_cordless.value` - Required when `is_cordless` is provided
...
- `massage_therapy_technique.value` - Required when `massage_therapy_technique` is provided
- `massager_form.value` - Required when `massager_form` is provided
...
- `directions.value` - Required when `directions` is provided
- `directions.language_tag` - Required when `directions` is provided
...
| `special_feature` | array | Provide the unique characteristics that set this massager apart from similar products, enhancing its functionality or user experience. |
...
| `runtime` | array | Provide the length of time the program takes to run |
...
| `is_heat_sensitive` | array | If the item is heat sensitive select yes, if it is not heat sensitive select no |
...
| `product_grade` | array | Provide the product's grade of use |
...
| `maximum_circumference` | array | Provide the maximum circumference value of the product |
| `is_expiration_dated_product` | array | Provide whether the product has an expiration date |
| `product_expiration_type` | array | Provide the way to determine when the massager expires, indicating how long it can be safely used or stored. |
...
| `labeler_name` | array | Specify the name of the labeler of the product |
| `target_use_body_part` | array | Provide the part of the body that this item is targeted for use on. |
| `is_cordless` | array | Please indicate if the product does not have a power cord and can function without connection to a main power supply. |
| `item_length_width_height` | array | Provide the length, width and height of the item in ready to use condition. |
| `massage_therapy_technique` | array | Provide the massage therapy techniques that the product supports. Massagers can provide multiple ways of manipulating muscle tissue, connective tissue, ligaments and tendons to improve well-being. |
| `massager_form` | array | Provide the shape and structure of the massager, designed for specific massage techniques and body areas. |
...
| `directions` | array | How is the product to be used? |
...
Provide the unique characteristics that set this massager apart from similar products, enhancing its functionality or user experience.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this massager apart from similar products, enhancing its functionality or user experience. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of time the program takes to run as a numeric value |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the benefit/result of the product in a maximum of 115 characters. Avoid special characters, caps, and bullets. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
If the item is heat sensitive select yes, if it is not heat sensitive select no

**Type:** array

**Title:** Is the Item Heat Sensitive?
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | If the item is heat sensitive select yes, if it is not heat sensitive select no |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `color` | array | No | Provide the color of lens |
| `marketplace_id` | object | No |  |
...
Provide the product's grade of use
...
Provide the maximum circumference value of the product

**Type:** array

**Title:** Maximum Circumference
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum circumference value of the product |
| `unit` | string | Yes | Provide the unit for maximum circumference |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the product has an expiration date |
| `marketplace_id` | object | No |  |

### product_expiration_type

Provide the way to determine when the massager expires, indicating how long it can be safely used or stored.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way to determine when the massager expires, indicating how long it can be safely used or stored. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the total number of days the item may be stored before expiration. Fulfillment technology requires this value in days. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the massager's storage duration before expiration in fulfillment centers. |
| `marketplace_id` | object | No |  |
...
| `type` | object | Yes | For items consumed by volume, weight, linear dimension etc., provide the unit of measure listed on the products. For products consumed as individual units, enter: count |
| `marketplace_id` | object | No |  |
...
| `type` | array | No | Provide the grip type of the product |

### labeler_name

Specify the name of the labeler of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the name of the labeler of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the part of the body that this item is targeted for use on. |
| `marketplace_id` | object | No |  |

### is_cordless

Please indicate if the product does not have a power cord and can function without connection to a main power supply.

**Type:** array

**Title:** Is Product Cordless
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Please indicate if the product does not have a power cord and can function without connection to a main power supply. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item measured from base to top when lying on a surface. |
| `length` | object | Yes | Provide the length of the item measured at the longer horizontal edge when lying on a surface. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item measured at the shorter horizontal edge when lying on a surface. |

#### item_length_width_height[].height

Provide the height of the item measured from base to top when lying on a surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item measured from base to top when lying on a surface. |
| `unit` | string | Yes | Provide the unit of measure for the item height. |

#### item_length_width_height[].length

Provide the length of the item measured at the longer horizontal edge when lying on a surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item measured at the longer horizontal edge when lying on a surface. |
| `unit` | string | Yes | Provide the unit of measure for the item length. |

#### item_length_width_height[].width

Provide the width of the item measured at the shorter horizontal edge when lying on a surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item measured at the shorter horizontal edge when lying on a surface. |
| `unit` | string | Yes | Provide the unit of measure for the item width. |

### massage_therapy_technique

Provide the massage therapy techniques that the product supports. Massagers can provide multiple ways of manipulating muscle tissue, connective tissue, ligaments and tendons to improve well-being.

**Type:** array

**Title:** Massage Therapy Technique
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the massage therapy techniques that the product supports. Massagers can provide multiple ways of manipulating muscle tissue, connective tissue, ligaments and tendons to improve well-being. |
| `marketplace_id` | object | No |  |

### massager_form

Provide the shape and structure of the massager, designed for specific massage techniques and body areas.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the physical form of the massager. Massager forms are based on the structure and shape of the massager. |
| `marketplace_id` | object | No |  |
...
| `charge_time` | array | No | Enter how long it takes to fully charge the battery in hours. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide guidance on how this product should be used |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
