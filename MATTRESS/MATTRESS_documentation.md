...
| `is_portable[item].value` | Required in is_portable[item] object |
...
| `item_hardness[item].language_tag` | Required in item_hardness[item] object |
| `item_hardness[item].value` | Required in item_hardness[item] object |
...
| `mattress_coil_type[item].value` | Required in mattress_coil_type[item] object |
| `mattress_comfort_layer_material[item].value` | Required in mattress_comfort_layer_material[item] object |
| `mattress_type[item].value` | Required in mattress_type[item] object |
...
| `number_of_layers[item].value` | Required in number_of_layers[item] object |
...
| `number_of_mattress_coils[item].value` | Required in number_of_mattress_coils[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the mattress, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Specify if the product is portable |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the hardness of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the number of layers |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the style of the mattress top, indicating the surface design or comfort layer incorporated into the uppermost part of the mattress. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
**Title:** Mattress Comfort Layer Material
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Please provide the type of material used for the comfort layer of the mattress. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Please provide the type of coil or coil system used for the support layer of the mattress. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the length of the item from head to toe in ready to use condition. |
| `marketplace_id` | object | No |  |
| `thickness` | object | Yes | Provide the thickness of the item from top to bottom in ready to use condition. |
| `width` | object | Yes | Provide the width of the item from side to side in ready to condition. |

#### item_length_width_thickness[].length

Provide the length of the item from head to toe in ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item from head to toe in ready to use condition. |
| `unit` | string | Yes | Select the unit of measure for Item length. |

#### item_length_width_thickness[].thickness

Provide the thickness of the item from top to bottom in ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the thickness of the item from top to bottom in ready to use condition. |
| `unit` | string | Yes | Select the unit of measure for item thickness. |
...
**Title:** Number of Mattress Coils
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of coils contained in the support core of a coil mattress. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific type of mattress. Mattress types are primarily defined by their use: on floor, on bed or in other places. |
| `marketplace_id` | object | No |  |
