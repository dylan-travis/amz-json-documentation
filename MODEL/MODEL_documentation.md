...
| `publisher[item].language_tag` | Required in publisher[item] object |
| `publisher[item].value` | Required in publisher[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the publisher for the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `description` | array | No | Select one of the following options:  battery_type_9v battery_type_a battery_type_aa battery_type_aaa battery_type_c battery_type_cr123a battery_type_cr2 battery_type_cr5 battery_type_d battery_type_lithium_ion battery_type_p76 battery_type_product_specific |
