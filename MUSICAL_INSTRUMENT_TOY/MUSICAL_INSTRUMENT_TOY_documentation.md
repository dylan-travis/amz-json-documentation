# MUSICAL_INSTRUMENT_TOY Schema Documentation
...
| `compliance_instrument_type[item].value` | Required in compliance_instrument_type[item] object |
...
| `number_of_settings[item].value` | Required in number_of_settings[item] object |
...
- `number_of_settings.value` - Required when `number_of_settings` is provided
...
- `compliance_instrument_type.value` - Required when `compliance_instrument_type` is provided
...
| `age_range_description` | array | Provide the suggested age range for the musical instrument toy, indicating the appropriate developmental stage for its use. |
...
| `sub_brand` | array | Provide the secondary brand information related to the toy musical instrument, such as licensed or franchise details. |
...
| `number_of_settings` | array | The number of settings the item has |
...
| `compliance_instrument_type` | array | Provide the type of instrument the item is imitating, for compliance purposes. |
...
Provide the suggested age range for the musical instrument toy, indicating the appropriate developmental stage for its use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suggested age range for the musical instrument toy, indicating the appropriate developmental stage for its use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand information related to the toy musical instrument, such as licensed or franchise details.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy musical instrument, such as licensed or franchise details. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The number of settings the item has
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Specify the number of settings in the item |
| `marketplace_id` | object | No |  |
...
| `description` | array | No | Provide the details about the battery used to power the item, its type, capacity, and how it's installed or replaced. |
...
### compliance_instrument_type

Provide the type of instrument the item is imitating, for compliance purposes.

**Type:** array

**Title:** Compliance - Instrument Type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of instrument the item is imitating, for compliance purposes. |
| `marketplace_id` | object | No |  |
