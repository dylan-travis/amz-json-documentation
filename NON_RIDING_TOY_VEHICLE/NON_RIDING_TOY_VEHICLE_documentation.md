# NON_RIDING_TOY_VEHICLE Schema Documentation
...
| `compliance_age_range[item].value` | Required in compliance_age_range[item] object |
...
| `compliance_recommended_age[item].value` | Required in compliance_recommended_age[item] object |
| `compliance_toy_material[item].value` | Required in compliance_toy_material[item] object |
| `compliance_toy_type[item].value` | Required in compliance_toy_type[item] object |
...
| `toy_vehicle_form[item].language_tag` | Required in toy_vehicle_form[item] object |
| `toy_vehicle_form[item].value` | Required in toy_vehicle_form[item] object |
...
- `toy_vehicle_form.value` - Required when `toy_vehicle_form` is provided
- `toy_vehicle_form.language_tag` - Required when `toy_vehicle_form` is provided
...
- `compliance_toy_type.value` - Required when `compliance_toy_type` is provided
...
| `age_range_description` | array | Provide the recommended ages for safe use of the item, based on factors like complexity, small parts, and skill level. |
...
| `subject_character` | array | Provide the main character represented by the toy vehicle, indicating the fictional or real-world figure associated with the item. |
...
| `sub_brand` | array | Provide the secondary brand information related to the toy vehicle, such as licensed or franchise names associated with the product. |
...
| `customer_package_type` | array | Provide the packaging option for the item, how it will be delivered, like a box or bag. |
| `operation_mode` | array | Provide the way the toy vehicle operates, indicating whether it functions manually or automatically. |
...
| `team_name` | array | Provide the name of the sports team associated with the toy vehicle, representing the team's branding on the product. |
| `scale_name` | array | Provide the name indicating the size ratio of the toy vehicle compared to its full-sized counterpart. |
...
| `toy_vehicle_form` | array | Provide the type of vehicle the toy represents, such as a car, truck, boat, or airplane. |
...
| `num_batteries` | array | Provide the number and type of batteries needed to operate the item, required for powering and functioning. |
...
| `compliance_toy_type` | array | Provide the category in which the item would be characterized, for compliance purposes. |
...
Provide the recommended ages for safe use of the item, based on factors like complexity, small parts, and skill level.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for the toy vehicle, indicating the intended or appropriate ages for safe and enjoyable play. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main character represented by the toy vehicle, indicating the fictional or real-world figure associated with the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the toy vehicle, indicating the fictional or real-world figure associated with the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand information related to the toy vehicle, such as licensed or franchise names associated with the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy vehicle, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the packaging option for the item, how it will be delivered, like a box or bag.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of packaging for the toy vehicle, indicating if it has been certified as Frustration-Free Packaging (FFP). |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### operation_mode

Provide the way the toy vehicle operates, indicating whether it functions manually or automatically.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the toy vehicle operates, indicating whether it functions manually or automatically. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the toy vehicle, representing the team's branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the toy vehicle, representing the team's branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### scale_name

Provide the name indicating the size ratio of the toy vehicle compared to its full-sized counterpart.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name indicating the size ratio of the toy vehicle compared to its full-sized counterpart. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the toy vehicle's highest operational velocity. |
| `marketplace_id` | object | No |  |
...
Provide the type of vehicle the toy represents, such as a car, truck, boat, or airplane.

**Type:** array

**Title:** Toy Vehicle Form
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of vehicle the toy represents, such as a car, truck, boat, or airplane. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `description` | array | No | Provide the details about the battery used to power the item, its type, capacity, and other relevant information. |
...
Provide the number and type of batteries needed to operate the item, required for powering and functioning.
...
Provide the category in which the item would be characterized, for compliance purposes.

**Type:** array

**Title:** Compliance - Toy Type

**Required:** No

**Examples:**

- `Cars, Dolls or Human-Like Toy`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the category in which the item would be characterized, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
**Title:** Compliance - Recommended Age
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age that the item is intended or appropriate for its use, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the primary material used in the item's manufacturing process, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age group the item is intended for use, for compliance purposes. Baby/Infant is defined as a body height not exceeding 86 cm. |
| `marketplace_id` | object | No |  |
