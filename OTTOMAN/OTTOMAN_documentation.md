...
| `fabric_type` | array | Provide the material used to make the upholstery covering the item, such as cotton, polyester, or leather. |
...
| `team_name` | array | Provide the name of the sports team associated with the ottoman, indicating the team-themed design or branding on the furniture. |
...
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely support, the highest load it can bear without issues. |
...
Provide the material used to make the upholstery covering the item, such as cotton, polyester, or leather.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials used in the ottoman's upholstery, listing all fabrics with their percentage composition. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the storage volume capacity of the ottoman. |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the ottoman, indicating the team-themed design or branding on the furniture.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the ottoman, indicating the team-themed design or branding on the furniture. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely support, the highest load it can bear without issues.
...
| `height` | object | Yes | Provide the measurement of the item from the floor to the top in an assembled state. The top of the ottoman is defined as the top of the seat. |
| `marketplace_id` | object | No |  |
...
Provide the measurement of the item from the floor to the top in an assembled state. The top of the ottoman is defined as the top of the seat.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the item from the floor to the top in an assembled state. The top of the ottoman is defined as the top of the seat. |
