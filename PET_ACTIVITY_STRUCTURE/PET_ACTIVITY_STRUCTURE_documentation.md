# PET_ACTIVITY_STRUCTURE Schema Documentation
...
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the appropriate life stage of the pet it's designed for. |
...
| `mounting_type` | array | Provide the product's mounting type. |
...
| `number_of_levels` | array | Provide the number of separate platforms or tiers the item has for pets to climb, perch, or play on. |
...
Provide the age range the item is suitable for, indicating the appropriate life stage of the pet it's designed for.
...
Provide the product's mounting type.
...
Provide the number of separate platforms or tiers the item has for pets to climb, perch, or play on.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of levels that the item offers |
| `marketplace_id` | object | No |  |
