# PET_BED_MAT Schema Documentation
...
| `breed_recommendation[item].language_tag` | Required in breed_recommendation[item] object |
| `breed_recommendation[item].value` | Required in breed_recommendation[item] object |
...
| `cover[item].material[item].language_tag` | Required in cover[item].material[item] object |
| `cover[item].material[item].language_tag` | Required in cover[item].material[item] object |
| `cover[item].material[item].value` | Required in cover[item].material[item] object |
| `cover[item].material[item].value` | Required in cover[item].material[item] object |
...
| `dog_breed_size[item].value` | Required in dog_breed_size[item] object |
...
| `item_length_width_thickness[item].length` | Required in item_length_width_thickness[item] object |
| `item_length_width_thickness[item].length.unit` | Required in item_length_width_thickness[item].length object |
| `item_length_width_thickness[item].length.unit` | Required in item_length_width_thickness[item].length object |
| `item_length_width_thickness[item].length.value` | Required in item_length_width_thickness[item].length object |
| `item_length_width_thickness[item].length.value` | Required in item_length_width_thickness[item].length object |
| `item_length_width_thickness[item].thickness` | Required in item_length_width_thickness[item] object |
| `item_length_width_thickness[item].thickness.unit` | Required in item_length_width_thickness[item].thickness object |
| `item_length_width_thickness[item].thickness.unit` | Required in item_length_width_thickness[item].thickness object |
| `item_length_width_thickness[item].thickness.value` | Required in item_length_width_thickness[item].thickness object |
| `item_length_width_thickness[item].thickness.value` | Required in item_length_width_thickness[item].thickness object |
| `item_length_width_thickness[item].width` | Required in item_length_width_thickness[item] object |
| `item_length_width_thickness[item].width.unit` | Required in item_length_width_thickness[item].width object |
| `item_length_width_thickness[item].width.unit` | Required in item_length_width_thickness[item].width object |
| `item_length_width_thickness[item].width.value` | Required in item_length_width_thickness[item].width object |
| `item_length_width_thickness[item].width.value` | Required in item_length_width_thickness[item].width object |
...
| `pet_type[item].value` | Required in pet_type[item] object |
...
- `breed_recommendation.value` - Required when `breed_recommendation` is provided
- `breed_recommendation.language_tag` - Required when `breed_recommendation` is provided
...
- `dog_breed_size.value` - Required when `dog_breed_size` is provided
...
- `pet_type.value` - Required when `pet_type` is provided
...
| `special_feature` | array | Provide the unique characteristics that set this pet bed or mat apart from similar products, enhancing comfort or functionality for pets. |
...
| `breed_recommendation` | array | Provide the recommended breed the item is for. Breeds are groups within a species with similar traits such as size, color, or coat features. |
...
| `item_form` | array | Provide the physical shape or design of the item, the way it is constructed or arranged to serve its purpose. |
...
| `team_name` | array | Provide the sports team name associated with the pet bed or mat, indicating the team-themed design or branding on the product. |
...
| `dog_breed_size` | array | Provide the specific dog breed size that the product is intended for. Breed size is a classification of dogs based on their relative sizes. |
...
| `pet_type` | array | Provide the broad classification of pet that the item is designed to be used by, or for. |
...
Provide the unique characteristics that set this pet bed or mat apart from similar products, enhancing comfort or functionality for pets.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this pet bed or mat apart from similar products, enhancing comfort or functionality for pets. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the recommended breed the item is for. Breeds are groups within a species with similar traits such as size, color, or coat features.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the recommended breed the item is for. Breeds are groups within a species with similar traits such as size, color, or coat features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the physical shape or design of the item, the way it is constructed or arranged to serve its purpose.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the shape or structure of the pet bed or mat, indicating its design for pet comfort and use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the sports team name associated with the pet bed or mat, indicating the team-themed design or branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the sports team name associated with the pet bed or mat, indicating the team-themed design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Describe the material of the item's cover |
...
**Title:** Item Dimensions L x W x Thickness
...
| `marketplace_id` | object | No |  |
| `thickness` | object | Yes | Provide the thickness of the item when lying on a surface. The thickness is the distance between the bottom surface and the top edge. |
...
#### item_length_width_thickness[].length
...
| `unit` | string | Yes | Select the unit of measure for the item length. |

#### item_length_width_thickness[].thickness

Provide the thickness of the item when lying on a surface. The thickness is the distance between the bottom surface and the top edge.

**Type:** object

**Title:** Item Thickness Bottom to Top
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the thickness of the item when lying on a surface. The thickness is the distance between the bottom surface and the top edge. |
| `unit` | string | Yes | Select the unit of measure for the item thickness. |

#### item_length_width_thickness[].width
...
Provide the specific dog breed size that the product is intended for. Breed size is a classification of dogs based on their relative sizes.

**Type:** array

**Title:** Dog Breed Size
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific dog breed size that the product is intended for. Breed size is a classification of dogs based on their relative sizes. |
| `marketplace_id` | object | No |  |
...
Provide the broad classification of pet that the item is designed to be used by, or for.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the broad classification of pet that the item is designed to be used by, or for. |
| `marketplace_id` | object | No |  |
