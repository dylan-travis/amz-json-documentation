# PET_SUPPLIES Schema Documentation
...
| `ingredients[item].language_tag` | Required in ingredients[item] object |
| `ingredients[item].value` | Required in ingredients[item] object |
...
- `ingredients.value` - Required when `ingredients` is provided
- `ingredients.language_tag` - Required when `ingredients` is provided
...
| `ingredients` | array | List all the ingredients of the food item. This should agree with the list of ingredients on the item package. |
...
List all the ingredients of the food item. This should agree with the list of ingredients on the item package.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | List all the ingredients of the food item. This should agree with the list of ingredients on the item package. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the item's expiration type. The expiration type designates how, or when from, an item's expiry can be determined. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the total number of days the item may be stored before expiration. Fulfillment technology requires this value in days. |
| `marketplace_id` | object | No |  |
