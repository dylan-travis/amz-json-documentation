...
| `compliance_filling_type[item].value` | Required in compliance_filling_type[item] object |
...
| `item_thickness[item].unit` | Required in item_thickness[item] object |
...
| `pillow_type[item].value` | Required in pillow_type[item] object |
| `pillowcase_closure_depth[item].unit` | Required in pillowcase_closure_depth[item] object |
| `pillowcase_closure_depth[item].value` | Required in pillowcase_closure_depth[item] object |
| `pillowcase_closure_width[item].unit` | Required in pillowcase_closure_width[item] object |
| `pillowcase_closure_width[item].value` | Required in pillowcase_closure_width[item] object |
| `pillowcase_length[item].unit` | Required in pillowcase_length[item] object |
| `pillowcase_length[item].value` | Required in pillowcase_length[item] object |
| `pillowcase_width[item].unit` | Required in pillowcase_width[item] object |
| `pillowcase_width[item].value` | Required in pillowcase_width[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the occasion that the item is designed for. Occasion types include holidays and major life events. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `count` | array | No | Provide the thread count of the product |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the thickness of the item as a decimal |
| `marketplace_id` | object | No |  |
| `unit` | string | Yes | Select the unit of measure for Item Thickness. If a value is provided for Item Thickness, you must also enter the corresponding unit. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `length` | object | Yes | Provide the measurement of the length of the item in ready to use condition.  Length is  a measurement of the longer edge of the item. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the measurement of the width measured side to side of the item in ready to use condition. Width is a measurement of the shorter edge of the item. |

#### item_length_width[].length

Provide the measurement of the length of the item in ready to use condition.  Length is  a measurement of the longer edge of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the length of the item in ready to use condition.  Length is  a measurement of the longer edge of the item. |
| `unit` | string | Yes | Select the unit of measure for Item length. |

#### item_length_width[].width

Provide the measurement of the width measured side to side of the item in ready to use condition. Width is a measurement of the shorter edge of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the width measured side to side of the item in ready to use condition. Width is a measurement of the shorter edge of the item. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of the pillow in relation to its shape, usage and features. |
| `marketplace_id` | object | No |  |
...
**Title:** Pillowcase Closure Width
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the pillowcase closure on the item. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's Pillowcase Closure Width |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length dimension of the pillowcase which is important for fit on the pillow insert. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's Pillowcase Length |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width dimension of the pillowcases included with the item. The width is important for fit on the pillow insert. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's Pillowcase Width |
| `marketplace_id` | object | No |  |
...
**Title:** Pillowcase Closure Depth
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth measurement of the pillowcase closure flap. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's Pillowcase Closure Depth |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the material found inside the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
