...
| `collar_style[item].language_tag` | Required in collar_style[item] object |
| `collar_style[item].value` | Required in collar_style[item] object |
...
| `planter_form[item].value` | Required in planter_form[item] object |
| `pocket_description[item].language_tag` | Required in pocket_description[item] object |
| `pocket_description[item].value` | Required in pocket_description[item] object |
...
- `collar_style.value` - Required when `collar_style` is provided
- `collar_style.language_tag` - Required when `collar_style` is provided
...
- `pocket_description.value` - Required when `pocket_description` is provided
- `pocket_description.language_tag` - Required when `pocket_description` is provided
...
- `planter_form.value` - Required when `planter_form` is provided
...
| `mounting_type` | array | Provide the way the item is designed to be attached or supported, how it is meant to be placed or positioned. |
...
| `number_of_levels` | array | Provide the number of levels that the item offers |
...
| `planter_form` | array | Provide the form of the planter. The form classifies planters based on shared characteristics, shape, and height. |
...
Provide the type of living organism the item is designed to cultivate, whether a plant, mushroom, or other.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the plant or animal product type |
| `marketplace_id` | object | No |  |
...
Provide the style of collar used by the item. The collar style is determined by overall shape, design, and form of an item's collar.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the style of collar used by the item. The collar style is determined by overall shape, design, and form of an item's collar. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Enter the appropriate description. Mandatory if style is a denim, short or pant style.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the pocket description |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the item is designed to be attached or supported, how it is meant to be placed or positioned.
...
Provide the number of levels that the item offers
...
Provide the form of the planter. The form classifies planters based on shared characteristics, shape, and height.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the form of the planter. The form classifies planters based on shared characteristics and shape. |
| `marketplace_id` | object | No |  |
