# PLAY_WORKSTATION Schema Documentation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for children to use the play workstation, indicating the intended user group for the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of item from side to side when placed in the manner in which it is expected to be used. |
...
| `unit` | string | Yes | Provide the unit of measure used to measure the item's depth. |
...
| `unit` | string | Yes | Provide the unit of measure used to measure the item's height. |

#### item_depth_width_height[].width

Provide the width of item from side to side when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of item from side to side when placed in the manner in which it is expected to be used. |
