# PORTABLE_FREESTANDING_SHELTER Schema Documentation
...
| `coverage[item].language_tag` | Required in coverage[item] object |
| `coverage[item].value` | Required in coverage[item] object |
...
| `floor_area[item].value` | Required in floor_area[item] object |
...
| `max_ceiling_height[item].unit` | Required in max_ceiling_height[item] object |
| `max_ceiling_height[item].value` | Required in max_ceiling_height[item] object |
...
| `minimum_ceiling_height[item].unit` | Required in minimum_ceiling_height[item] object |
| `minimum_ceiling_height[item].value` | Required in minimum_ceiling_height[item] object |
...
| `number_of_guylines[item].value` | Required in number_of_guylines[item] object |
...
| `pole_material_type[item].language_tag` | Required in pole_material_type[item] object |
| `pole_material_type[item].value` | Required in pole_material_type[item] object |
...
| `ultraviolet_light_protection[item].language_tag` | Required in ultraviolet_light_protection[item] object |
| `ultraviolet_light_protection[item].value` | Required in ultraviolet_light_protection[item] object |
...
- `pole_material_type.value` - Required when `pole_material_type` is provided
- `pole_material_type.language_tag` - Required when `pole_material_type` is provided
...
- `ultraviolet_light_protection.value` - Required when `ultraviolet_light_protection` is provided
- `ultraviolet_light_protection.language_tag` - Required when `ultraviolet_light_protection` is provided
...
- `floor_area.value` - Required when `floor_area` is provided
...
- `number_of_guylines.value` - Required when `number_of_guylines` is provided
- `minimum_ceiling_height.value` - Required when `minimum_ceiling_height` is provided
- `minimum_ceiling_height.unit` - Required when `minimum_ceiling_height` is provided
- `max_ceiling_height.value` - Required when `max_ceiling_height` is provided
- `max_ceiling_height.unit` - Required when `max_ceiling_height` is provided
...
| `pole_material_type` | array | The material type of the poles used in the product |
...
| `team_name` | array | Provide the name of the sports team associated with the portable shelter, indicating the team affiliation or branding of the product. |
| `ultraviolet_light_protection` | array | Provide the products ultraviolet light protection |
...
| `floor_area` | array | Provide the total ground space the item covers when set up, the area it occupies on a flat surface. |
...
| `number_of_guylines` | array | Provide the number of guylines included with the item.  Guylines are tensioned cables which provide additional stability for a freestanding structure. |
| `minimum_ceiling_height` | array | Provide the minimum ceiling height required to accommodate the item. |
| `max_ceiling_height` | array | Provide the maximum ceiling height that the item can be installed on. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the amount or type of coverage the item has |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The material type of the poles used in the product

**Type:** array

**Title:** Pole Material Type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the material used to make the poles that support the structure of the portable shelter. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the portable shelter, indicating the team affiliation or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the portable shelter, indicating the team affiliation or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### ultraviolet_light_protection

Provide the products ultraviolet light protection

**Type:** array

**Title:** Ultraviolet Light Protection
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the products ultraviolet light protection |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the total ground space the item covers when set up, the area it occupies on a flat surface.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Specify the area that the product occupies |
| `unit` | string | No | Specify the corresponding unit |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item measured from base to top when assembled and placed in the manner in which it is expected to be used. |
| `length` | object | Yes | Provide the length of the item measured at the longer horizontal edge when assembled and placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item measured at the shorter horizontal edge assembled and placed in the manner in which it is expected to be used. |

#### item_length_width_height[].height

Provide the height of the item measured from base to top when assembled and placed in the manner in which it is expected to be used.

**Type:** object

**Title:** Height base to top when assembled
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item measured from base to top when assembled and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the unit of measure for the item height. |

#### item_length_width_height[].length

Provide the length of the item measured at the longer horizontal edge when assembled and placed in the manner in which it is expected to be used.

**Type:** object

**Title:** Length longer edge when assembled
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item measured at the longer horizontal edge when assembled and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the unit of measure for the item length. |

#### item_length_width_height[].width

Provide the width of the item measured at the shorter horizontal edge assembled and placed in the manner in which it is expected to be used.

**Type:** object

**Title:** Width shorter edge when assembled
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item measured at the shorter horizontal edge assembled and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the unit of measure for the item width. |

### number_of_guylines

Provide the number of guylines included with the item.  Guylines are tensioned cables which provide additional stability for a freestanding structure.

**Type:** array

**Title:** Number of Guylines
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of guylines included with the item.  Guylines are tensioned cables which provide additional stability for a freestanding structure. |
| `marketplace_id` | object | No |  |

### minimum_ceiling_height

Provide the minimum ceiling height required to accommodate the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the minimum ceiling height required to accommodate the item. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the product's minimum required ceiling clearance. |
| `marketplace_id` | object | No |  |

### max_ceiling_height

Provide the maximum ceiling height that the item can be installed on.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum ceiling height that the item can be installed on. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the shelter's maximum ceiling height. |
| `marketplace_id` | object | No |  |
