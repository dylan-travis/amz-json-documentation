# PRETEND_PLAY_TOY Schema Documentation
...
| `age_range_description` | array | Provide the age range the item is suitable for, describing the intended users and their developmental stage. |
...
| `sub_brand` | array | Provide the secondary brand information related to the pretend play toy, such as licensed or franchise names associated with the product. |
...
| `educational_objective` | array | Provide the learning goal or skill the item aims to develop, like problem-solving or hand-eye coordination. |
...
Provide the age range the item is suitable for, describing the intended users and their developmental stage.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the recommended age range for the pretend play toy, indicating the appropriate developmental stage for safe and engaging use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand information related to the pretend play toy, such as licensed or franchise names associated with the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the pretend play toy, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the learning goal or skill the item aims to develop, like problem-solving or hand-eye coordination.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the learning or developmental goal the toy is designed to help achieve, such as cognitive skills or motor abilities. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
