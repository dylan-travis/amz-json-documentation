# PULL_UP_BAR Schema Documentation
...
| `seating_group` | array |  |
| `maximum_weight_recommendation` | array | Provide the highest weight the item can safely support, the maximum load it can handle without breaking or becoming unstable. |
...
Provide the highest weight the item can safely support, the maximum load it can handle without breaking or becoming unstable.
