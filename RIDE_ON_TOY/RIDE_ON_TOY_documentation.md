# RIDE_ON_TOY Schema Documentation
...
| `compliance_toy_voltage[item].value` | Required in compliance_toy_voltage[item] object |
...
- `compliance_toy_voltage.value` - Required when `compliance_toy_voltage` is provided
...
| `age_range_description` | array | Provide the recommended ages for safe use of the item, considering factors like size, complexity, and motor skills required. |
...
| `subject_character` | array | Provide the main character represented by the ride on toy, indicating the fictional or real person the item is designed to resemble. |
...
| `sub_brand` | array | Provide the secondary brand information related to the ride on toy, such as licensed or franchise details. |
...
| `team_name` | array | Provide the name of the sports team associated with the ride on toy, representing the product's themed design or branding. |
...
| `compliance_toy_voltage` | array | Provide the voltage rating of the item, for compliance purposes. |
...
Provide the recommended ages for safe use of the item, considering factors like size, complexity, and motor skills required.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age range for which the ride on toy is suitable, considering safety and developmental appropriateness. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main character represented by the ride on toy, indicating the fictional or real person the item is designed to resemble.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the ride on toy, indicating the fictional or real person the item is designed to resemble. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand information related to the ride on toy, such as licensed or franchise details.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the ride on toy, such as licensed or franchise details. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the ride on toy, representing the product's themed design or branding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the ride on toy, representing the product's themed design or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
### compliance_toy_voltage

Provide the voltage rating of the item, for compliance purposes.

**Type:** array

**Title:** Compliance - Toy Voltage
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the voltage rating of the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
