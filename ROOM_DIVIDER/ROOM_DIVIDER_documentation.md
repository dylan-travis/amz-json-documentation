# ROOM_DIVIDER Schema Documentation
...
| `number_of_panels[item].value` | Required in number_of_panels[item] object |
...
- `number_of_panels.value` - Required when `number_of_panels` is provided
...
| `special_feature` | array | Provide the unique characteristics that set this room divider apart from similar products, enhancing its functionality or design. |
...
| `mounting_type` | array | Provide the way the item is installed or attached, how it is set up or secured in place. |
...
| `team_name` | array | Provide the name of the sports team associated with the room divider, indicating the team represented on the product. |
...
| `room_type` | array | Provide the type of room the divider is designed for, indicating its intended use and influencing its size, features, or aesthetics. |
| `width_range` | array | Width range for blinds |
| `number_of_panels` | array | Number of panels on an item of furniture. |
...
Provide the unique characteristics that set this room divider apart from similar products, enhancing its functionality or design.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this room divider apart from similar products, enhancing its functionality or design. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the item is installed or attached, how it is set up or secured in place.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the room divider is attached or positioned, indicating how it is secured or placed in the space. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the room divider, indicating the team represented on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the room divider, indicating the team represented on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the type of room the divider is designed for, indicating its intended use and influencing its size, features, or aesthetics.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the divider is designed for, indicating its intended use and influencing its size, features, or aesthetics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Number of panels on an item of furniture.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Number of panels on an item of furniture. |
| `marketplace_id` | object | No |  |
...
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the measurement of the width of the item measured from side to side in ready to use condition. The measurement of width includes all panels. |
...
Provide the measurement of the width of the item measured from side to side in ready to use condition. The measurement of width includes all panels.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the width of the item measured from side to side in ready to use condition. The measurement of width includes all panels. |
