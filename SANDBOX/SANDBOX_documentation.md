...
| `team_name` | array | Provide the name of the sports team associated with the sandbox, representing the team's branding or theme on the product. |
| `scent` | array | Provide a description of the scent of the item |
| `maximum_weight_recommendation` | array | Provide the highest weight the item can safely hold, the limit before potential damage or failure. |
...
Provide the name of the sports team associated with the sandbox, representing the team's branding or theme on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the sandbox, representing the team's branding or theme on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the highest weight the item can safely hold, the limit before potential damage or failure.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide height  of the item from top to bottom when placed in the manner in which it is expected to be used. |
...
Provide height  of the item from top to bottom when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide height  of the item from top to bottom when placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item height. |
