# SCIENCE_FUNDAMENTALS_KIT Schema Documentation
...
| `subject[item].language_tag` | Required in subject[item] object |
| `subject[item].type` | Required in subject[item] object |
| `subject[item].value` | Required in subject[item] object |
...
- `subject` - Required when selectors `marketplace_id`, `type`, `source`, `language_tag` are specified
...
- `subject.value` - Required when `subject` is provided
- `subject.language_tag` - Required when `subject` is provided
- `subject.type` - Required when `subject` is provided
...
| `age_range_description` | array | Provide the age range the item is suitable for, explaining the appropriate ages for using and learning from the kit. |
...
| `sub_brand` | array | Provide the secondary brand or franchise associated with the item, such as a licensed character or theme. |
...
| `team_name` | array | Provide the team name associated with the science kit, if applicable to the product's theme or branding. |
| `scent` | array | Provide a description of the scent of the item |
| `educational_objective` | array | Provide the key learning goal or skill the item aims to teach, the main educational purpose behind the activities. |
| `subject` | array | Provide the primary subject of the item |
...
Provide the age range the item is suitable for, explaining the appropriate ages for using and learning from the kit.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for using the science kit, indicating the intended audience for the educational materials and experiments. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand or franchise associated with the item, such as a licensed character or theme.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the science kit, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the team name associated with the science kit, if applicable to the product's theme or branding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the team name associated with the science kit, if applicable to the product's theme or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the key learning goal or skill the item aims to teach, the main educational purpose behind the activities.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the learning or developmental goal that the science kit is designed to help achieve. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
- `Fiction, History, Classics`

**Selectors:** `marketplace_id`, `type`, `source`, `language_tag`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the primary subject of the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
| `source` | string | No | Provide subject Source |
| `type` | string | Yes | Please select the appropriate subject type which best describes the content of the book |
...
| `description` | array | No | Provide the details about the battery included in the item, its purpose, how it powers components, and its specifications. |
