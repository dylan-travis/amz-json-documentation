# SCULPTURE Schema Documentation
...
| `gem_type[item].language_tag` | Required in gem_type[item] object |
| `gem_type[item].value` | Required in gem_type[item] object |
...
- `gem_type.value` - Required when `gem_type` is provided
- `gem_type.language_tag` - Required when `gem_type` is provided
...
| `style` | array | Provide the artistic movement or design approach used for the item, the overall aesthetic and creative vision. |
...
| `subject_character` | array | Provide the main character depicted in the sculpture, representing the primary subject or figure portrayed in the three-dimensional artwork. |
...
| `gem_type` | array | Enter the gem type associated with your product |
| `occasion_type` | array | Provide the occasion or event the item is designed for, like celebrations, holidays, or home decor. |
...
| `mounting_type` | array | Provide the way the item is designed to be displayed or secured, such as on a base, wall mount, or freestanding. |
...
Provide the artistic movement or design approach used for the item, the overall aesthetic and creative vision.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the aesthetic design approach of the sculpture, describing its distinctive visual characteristics and artistic representation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main character depicted in the sculpture, representing the primary subject or figure portrayed in the three-dimensional artwork.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character depicted in the sculpture, representing the primary subject or figure portrayed in the three-dimensional artwork. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Enter the gem type associated with your product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Enter the gem type associated with your product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### occasion_type

Provide the occasion or event the item is designed for, like celebrations, holidays, or home decor.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event that the sculpture is designed to commemorate or celebrate. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the item is designed to be displayed or secured, such as on a base, wall mount, or freestanding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the sculpture is designed to be attached or displayed, such as wall-mounted or freestanding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
