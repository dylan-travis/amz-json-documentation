...
| `product_name[item].value` | Required in product_name[item] object |
...
| `shelf_thickness[item].unit` | Required in shelf_thickness[item] object |
| `shelf_thickness[item].value` | Required in shelf_thickness[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age range for which the shelf is intended or appropriate, considering its design, safety features, and intended use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the kind of shelf integrated into the item, based on materials, style, and mounting characteristics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the shelf is designed to be attached or secured, indicating how it can be installed or fixed in place. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the shelf, indicating the team-themed design or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide one or two words to describe the type of product being sold |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the shelf is designed or intended for use in, which may influence its size, features, or aesthetics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the minimum doorway width needed for the shelf to pass through. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the shelf thickness of the item. It is the horizontal plane thickness of the shelf tier upon which the objects will be placed. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the thickness of the shelf's horizontal plane. |
| `marketplace_id` | object | No |  |
