...
| `age_range_description` | array | Provide the suitable age range for using the sled, indicating the intended or appropriate user group for the item. |
...
| `team_name` | array | Provide the name of the team or group associated with the item, identifying who it represents or belongs to. |
| `occupancy` | array | Provide the maximum number of people the sled can safely accommodate for sliding or transportation purposes. |
| `seating_group` | array |  |
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely support, the highest load it can handle without issues. |
...
Provide the suitable age range for using the sled, indicating the intended or appropriate user group for the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for using the sled, indicating the intended or appropriate user group for the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the team or group associated with the item, identifying who it represents or belongs to.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the sled, indicating the team affiliation or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### occupancy

Provide the maximum number of people the sled can safely accommodate for sliding or transportation purposes.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the maximum number of people the sled can safely accommodate for sliding or transportation purposes. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely support, the highest load it can handle without issues.
