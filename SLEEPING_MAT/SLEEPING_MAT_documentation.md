...
| `insulation[item].resistance[item].value` | Required in insulation[item].resistance[item] object |
| `insulation[item].resistance[item].value` | Required in insulation[item].resistance[item] object |
...
| `variety[item].language_tag` | Required in variety[item] object |
| `variety[item].value` | Required in variety[item] object |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | A number with up to 10 digits allowed to the left of the decimal point and 2 digits to the right of the decimal point. Please do not use commas. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `color` | array | No | An alphanumeric string; 50 characters maximum. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the sleeping mat, indicating the product's affiliation or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `resistance` | array | No | A number with up to 10 digits allowed to the left of the decimal point and 2 digits to the right of the decimal point. Please do not use commas. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Describes what variety of item this is. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the item’s thickness. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `energy_content` | array | No | A positive number. |
| `marketplace_id` | object | No |  |
| `packaging` | array | No | Select from one of the following:  batteries_only batteries_contained_in_equipment batteries_packed_with_equipment |
