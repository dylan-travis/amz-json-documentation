# SPORT_TABLE_GAME Schema Documentation
...
| `sport_type` | array | Provide the specific sports for which the table game is designed, indicating its intended use and gameplay style. |
| `league_name` | array | Name of league associated with this event. |
| `team_name` | array | Provide the name representing the team or side for the item, identifying the players or competitors in the game. |
...
Provide the specific sports for which the table game is designed, indicating its intended use and gameplay style.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific sports for which the table game is designed, indicating its intended use and gameplay style. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name representing the team or side for the item, identifying the players or competitors in the game.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the table game, representing the team's branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item measured from the floor to the top when assembled and placed in the manner in which it is expected to be used. |
...
Provide the height of the item measured from the floor to the top when assembled and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item measured from the floor to the top when assembled and placed in the manner in which it is expected to be used. |
