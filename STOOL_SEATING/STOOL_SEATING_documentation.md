# STOOL_SEATING Schema Documentation
...
| `seat[item].material_type[item].value` | Required in seat[item].material_type[item] object |
| `seat[item].width[item].language_tag` | Required in seat[item].width[item] object |
| `seat[item].width[item].language_tag` | Required in seat[item].width[item] object |
| `seat[item].width[item].value` | Required in seat[item].width[item] object |
| `seat[item].width[item].value` | Required in seat[item].width[item] object |
...
| `team_name` | array | Provide the name of the sports team associated with the stool, indicating the team branding or design featured on the seating product. |
...
Provide the name of the sports team associated with the stool, indicating the team branding or design featured on the seating product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the stool, indicating the team branding or design featured on the seating product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `width` | array | No | Provide the width of the seat |
