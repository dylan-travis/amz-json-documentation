# STORAGE_BOX Schema Documentation
...
| `number_of_compartments[item].value` | Required in number_of_compartments[item] object |
...
| `opening_mechanism[item].language_tag` | Required in opening_mechanism[item] object |
| `opening_mechanism[item].value` | Required in opening_mechanism[item] object |
...
| `recycled_content_percentage[item].value` | Required in recycled_content_percentage[item] object |
...
| `size_per_pearl[item].language_tag` | Required in size_per_pearl[item] object |
| `size_per_pearl[item].value` | Required in size_per_pearl[item] object |
...
- `size_per_pearl.value` - Required when `size_per_pearl` is provided
- `size_per_pearl.language_tag` - Required when `size_per_pearl` is provided
...
- `recycled_content_percentage.value` - Required when `recycled_content_percentage` is provided
...
| `special_feature` | array | Provide the unique characteristics that set this storage box apart from similar products, enhancing its functionality or appeal. |
...
| `size_per_pearl` | array | Provide the size of the pearl |
| `occasion_type` | array | Provide the holiday or major life event that the storage box is designed for, such as celebrations or significant milestones. |
...
| `material_feature` | array | Provide the special material properties of the item, like durability or resistance to elements, that make it suitable for storage. |
...
| `unit_count` | array | Provide the total number and type of units the item contains, indicating its capacity or amount. |
...
| `team_name` | array | Provide the name of the sports team associated with the storage box, indicating the team-specific design or branding on the product. |
...
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely hold, the highest load it's designed to support without issues. |
...
| `recycled_content_percentage` | array | Provide the percentage of recycled content of the product |
...
Provide the unique characteristics that set this storage box apart from similar products, enhancing its functionality or appeal.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this storage box apart from similar products, enhancing its functionality or appeal. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the size of the pearl

**Type:** array

**Title:** Size Per Pearl
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the size of the pearl |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### occasion_type

Provide the holiday or major life event that the storage box is designed for, such as celebrations or significant milestones.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event that the storage box is designed for, such as celebrations or significant milestones. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the storage box's volume capacity. |
| `marketplace_id` | object | No |  |

### material_feature

Provide the special material properties of the item, like durability or resistance to elements, that make it suitable for storage.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the features of the item relative to the material the item is made from. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the total number and type of units the item contains, indicating its capacity or amount.
...
Provide the name of the sports team associated with the storage box, indicating the team-specific design or branding on the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the storage box, indicating the team-specific design or branding on the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `size` | array | No | Provide the size of the item's head |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the opening mechanism for the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely hold, the highest load it's designed to support without issues.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of compartments that the item has |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height of the item measured from base to top when closed and placed in the manner in which it is expected to be used. |
| `length` | object | Yes | Provide the length of the item measured at the longer horizontal edge when closed and placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item measured at the shorter horizontal edge when closed and placed in the manner in which it is expected to be used. |

#### item_length_width_height[].height

Provide the height of the item measured from base to top when closed and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item measured from base to top when closed and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the unit of measure for the item height. |

#### item_length_width_height[].length

Provide the length of the item measured at the longer horizontal edge when closed and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item measured at the longer horizontal edge when closed and placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Provide the unit of measure for the item length. |

#### item_length_width_height[].width

Provide the width of the item measured at the shorter horizontal edge when closed and placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item measured at the shorter horizontal edge when closed and placed in the manner in which it is expected to be used. |
...
Provide the percentage of recycled content of the product

**Type:** array

**Title:** Recycled Content Percentage
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the percentage of recycled content of the product |
| `marketplace_id` | object | No |  |
