# STORAGE_HOOK Schema Documentation
...
| `mounting_type` | array | Provide the way the item attaches to a surface, like a wall or shelf, for hanging and storage. |
...
| `line_weight` | array | Provide the fishing line weight with the appropriate unit |
| `maximum_weight_recommendation` | array | Provide the highest weight the item can safely hold, the maximum load it can bear without failing. |
...
Provide the way the item attaches to a surface, like a wall or shelf, for hanging and storage.
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `maximum` | array | No | Specifies the maximum weight capacity. |
| `minimum` | array | No | Provide the minimum weight the item can safely hold, the lowest amount it's designed to support without failing. |
...
Provide the fishing line weight with the appropriate unit
...
Provide the highest weight the item can safely hold, the maximum load it can bear without failing.
