# STORAGE_RACK Schema Documentation
...
|-----------|-------------|
| `animal_theme[item].language_tag` | Required in animal_theme[item] object |
| `animal_theme[item].value` | Required in animal_theme[item] object |
...
| `cap[item].type[item].language_tag` | Required in cap[item].type[item] object |
| `cap[item].type[item].language_tag` | Required in cap[item].type[item] object |
| `cap[item].type[item].value` | Required in cap[item].type[item] object |
| `cap[item].type[item].value` | Required in cap[item].type[item] object |
...
| `pre_printed_text[item].language_tag` | Required in pre_printed_text[item] object |
| `pre_printed_text[item].value` | Required in pre_printed_text[item] object |
...
| `shelf[item].weight_capacity[item].unit` | Required in shelf[item].weight_capacity[item] object |
| `shelf[item].weight_capacity[item].unit` | Required in shelf[item].weight_capacity[item] object |
| `shelf[item].weight_capacity[item].value` | Required in shelf[item].weight_capacity[item] object |
| `shelf[item].weight_capacity[item].value` | Required in shelf[item].weight_capacity[item] object |
| `shelf_type[item].language_tag` | Required in shelf_type[item] object |
| `shelf_type[item].value` | Required in shelf_type[item] object |
...
- `pre_printed_text.value` - Required when `pre_printed_text` is provided
- `pre_printed_text.language_tag` - Required when `pre_printed_text` is provided
...
| `pre_printed_text` | array | The attribute indicates the Pre Printed Text of the product |
| `is_assembly_required` | array | Indicate whether or not the item requires assembly by the customer |
| `shelf_type` | array | Provide the kind of shelf integrated into the storage rack, considering its materials, style, and mounting characteristics. |
...
| `mounting_type` | array | Provide the method by which the storage rack is attached or secured, indicating how it is positioned for use. |
...
| `team_name` | array | Provide the name of the sports team associated with the storage rack, indicating the team-specific design or branding of the product. |
...
| `cap` | array | The attribute indicates Cap of the product |
...
| `room_type` | array | Provide the intended room for the storage rack, indicating the space where the item is designed to be used or placed. |
...
| `animal_theme` | array | Provide the animal figure or shape the item represents, like creatures printed on fabric or molded into the design. |
| `item_depth_width_height` | array | Provide the dimensions of the item when fully set up and ready for use, such as a rug unrolled or dishes on a rack. |
...
The attribute indicates the Pre Printed Text of the product

**Type:** array

**Title:** Pre Printed Text
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | The attribute indicates the Pre Printed Text of the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the kind of shelf integrated into the storage rack, considering its materials, style, and mounting characteristics.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the kind of shelf integrated into the storage rack, considering its materials, style, and mounting characteristics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the method by which the storage rack is attached or secured, indicating how it is positioned for use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the method by which the storage rack is attached or secured, indicating how it is positioned for use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the storage rack, indicating the team-specific design or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the storage rack, indicating the team-specific design or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
The attribute indicates Cap of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Specify the type of cap that the product has |
...
Provide the intended room for the storage rack, indicating the space where the item is designed to be used or placed.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended room for the storage rack, indicating the space where the item is designed to be used or placed. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `weight_capacity` | array | No | Provide the maximum weight capacity that a single shelf within a storage unit can support without being damaged. |
...
Provide the animal figure or shape the item represents, like creatures printed on fabric or molded into the design.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the animal that is either printed on the product or the product is shaped as. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### item_depth_width_height

Provide the dimensions of the item when fully set up and ready for use, such as a rug unrolled or dishes on a rack.
...
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width from side to side of the front of the item when placed in the manner in which it is expected to be used. |
...
Provide the width from side to side of the front of the item when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width from side to side of the front of the item when placed in the manner in which it is expected to be used. |
