# STRINGED_INSTRUMENTS Schema Documentation
...
| `operation_mode` | array | Provide the way the stringed instrument is played, indicating whether it requires manual or automatic operation. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the quantity of strings on the instrument, indicating the number of individual cords that produce sound when played. |
| `marketplace_id` | object | No |  |
...
Provide the way the stringed instrument is played, indicating whether it requires manual or automatic operation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the stringed instrument is played, indicating whether it requires manual or automatic operation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the back of the item, the solid surface behind the strings. |
