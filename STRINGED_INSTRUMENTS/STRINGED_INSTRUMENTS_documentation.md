...
| `operation_mode` | array | Provide the way the item produces sound, whether by plucking, strumming, or using a bow. |
...
Provide the way the item produces sound, whether by plucking, strumming, or using a bow.
