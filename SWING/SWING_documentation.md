...
| `finish_type` | array | Provide the surface treatment or coating applied to the item, affecting its appearance and durability. |
...
| `team_name` | array | Provide the name of the sports team associated with the swing, indicating the team affiliation or branding of the product. |
...
Provide the surface treatment or coating applied to the item, affecting its appearance and durability.
...
Provide the name of the sports team associated with the swing, indicating the team affiliation or branding of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the swing, indicating the team affiliation or branding of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | array | No | Provide the depth of the seat from front to back when not expanded, for proper seating position. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the depth of the item from front to back including the frame when placed in the manner in which it is expected to be used. |
| `height` | object | Yes | Provide the height of the item from top to bottom with the frame when placed in the manner in which it is expected to be used. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width from side to side of the front of the item including the frame when placed in the manner in which it is expected to be used. |

#### item_depth_width_height[].depth

Provide the depth of the item from front to back including the frame when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the depth of the item from front to back including the frame when placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Select the unit of measure for the item depth. |

#### item_depth_width_height[].height

Provide the height of the item from top to bottom with the frame when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height of the item from top to bottom with the frame when placed in the manner in which it is expected to be used. |
| `unit` | string | Yes | Select the unit of measure for the item height. |

#### item_depth_width_height[].width

Provide the width from side to side of the front of the item including the frame when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width from side to side of the front of the item including the frame when placed in the manner in which it is expected to be used. |
