...
| `base[item].color[item].value` | Required in base[item].color[item] object |
| `base_to_top_distance[item].unit` | Required in base_to_top_distance[item] object |
| `base_to_top_distance[item].value` | Required in base_to_top_distance[item] object |
...
| `battery[item].weight[item].value` | Required in battery[item].weight[item] object |
| `bench_quantity[item].value` | Required in bench_quantity[item] object |
...
| `collapsed_length_minimum[item].unit` | Required in collapsed_length_minimum[item] object |
| `collapsed_length_minimum[item].value` | Required in collapsed_length_minimum[item] object |
...
| `decorative_plating[item].value` | Required in decorative_plating[item] object |
| `dsa_responsible_party_address[item].value` | Required in dsa_responsible_party_address[item] object |
| `edge_style[item].language_tag` | Required in edge_style[item] object |
| `edge_style[item].value` | Required in edge_style[item] object |
| `edition[item].language_tag` | Required in edition[item] object |
| `edition[item].value` | Required in edition[item] object |
| `extended_length[item].unit` | Required in extended_length[item] object |
| `extended_length[item].value` | Required in extended_length[item] object |
...
| `feet_type[item].language_tag` | Required in feet_type[item] object |
| `feet_type[item].value` | Required in feet_type[item] object |
...
| `furniture_base_movement[item].value` | Required in furniture_base_movement[item] object |
...
| `handle[item].color[item].language_tag` | Required in handle[item].color[item] object |
| `handle[item].color[item].language_tag` | Required in handle[item].color[item] object |
| `handle[item].color[item].value` | Required in handle[item].color[item] object |
| `handle[item].color[item].value` | Required in handle[item].color[item] object |
| `handle[item].finish_type[item].language_tag` | Required in handle[item].finish_type[item] object |
| `handle[item].finish_type[item].language_tag` | Required in handle[item].finish_type[item] object |
| `handle[item].finish_type[item].value` | Required in handle[item].finish_type[item] object |
| `handle[item].finish_type[item].value` | Required in handle[item].finish_type[item] object |
| `handle[item].material[item].language_tag` | Required in handle[item].material[item] object |
| `handle[item].material[item].language_tag` | Required in handle[item].material[item] object |
| `handle[item].material[item].value` | Required in handle[item].material[item] object |
| `handle[item].material[item].value` | Required in handle[item].material[item] object |
| `handmade_classification[item].value` | Required in handmade_classification[item] object |
| `hardware_platform[item].language_tag` | Required in hardware_platform[item] object |
| `hardware_platform[item].value` | Required in hardware_platform[item] object |
| `has_tilting[item].value` | Required in has_tilting[item] object |
...
| `is_foldable[item].value` | Required in is_foldable[item] object |
| `is_fragile[item].value` | Required in is_fragile[item] object |
| `is_resizable[item].value` | Required in is_resizable[item] object |
| `is_stain_resistant[item].value` | Required in is_stain_resistant[item] object |
...
| `item_depth_width_height[item].width.value` | Required in item_depth_width_height[item].width object |
| `item_diameter[item].unit` | Required in item_diameter[item] object |
...
| `item_width[item].unit` | Required in item_width[item] object |
| `item_width[item].value` | Required in item_width[item] object |
...
| `line_size[item].language_tag` | Required in line_size[item] object |
| `line_size[item].value` | Required in line_size[item] object |
...
| `number_of_doors[item].value` | Required in number_of_doors[item] object |
...
| `number_of_racks[item].value` | Required in number_of_racks[item] object |
...
| `paper_size[item].language_tag` | Required in paper_size[item] object |
| `paper_size[item].value` | Required in paper_size[item] object |
...
| `table_design[item].value` | Required in table_design[item] object |
| `table_extension_mechanism[item].language_tag` | Required in table_extension_mechanism[item] object |
| `table_extension_mechanism[item].value` | Required in table_extension_mechanism[item] object |
...
| `top[item].material[item].value` | Required in top[item].material[item] object |
| `umbrella_hole_diameter[item].unit` | Required in umbrella_hole_diameter[item] object |
| `umbrella_hole_diameter[item].value` | Required in umbrella_hole_diameter[item] object |
| `unextended_seating_capacity[item].value` | Required in unextended_seating_capacity[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the style of the edge of the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age range for which the table is intended or appropriate, considering its design, size, and features. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the diameter of the item as a decimal |
| `marketplace_id` | object | No |  |
| `unit` | string | Yes | Select the unit of measure for Item Diameter. If a value is provided for Item Diameter, you must also enter the corresponding unit. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | If the item is resizable select yes, if it is not select no |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the size of the paper as a numeric value |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the product's line or point size |
| `unit` | string | No | Provide a unit of measure for the product's line or point size |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the hardware platform |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of racks. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `color` | array | No | Provide the dominant color of the item's handle. The color describes the specific hue visible on the outer surface layer of the handle. |
| `finish_type` | array | No | Provide the decorative coating applied to the item's handle, protecting and enhancing its appearance. |
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material that the handle or handles are made of |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of doors the product has |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the structural feature of the product can be folded or not. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | The type of feet on the item |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of base the product has or uses |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the furniture item, indicating the team-themed design or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Is the item made of a stain resistant material or has it been treated to be stain resistant |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Provide whether the table can tilt or change its angle, allowing for adjustment of the surface's position or viewing angle. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decimal_value` | number | No | Provide the maximum lifting height as a decimal value |
| `marketplace_id` | object | No |  |
| `unit` | string | No | Select the corresponding unit |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of room the table is designed for, influencing its size, features, and aesthetics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `marketplace_id` | object | No |  |
| `width` | array | No | Provide the horizontal measurement from front to back of the item's shelf, the flat surface used to place objects on. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the extended length of the item |
| `unit` | string | Yes | Provide the corresponding unit used to designate the table's length when fully extended. |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the minimum doorway width needed for the table to pass through. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the design type of the table. The table design represents a standard form of the table based around the specific user needs for example the structure of the surface. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the measurement of the height measured from floor to top of the item in a ready to use condition. |
| `length` | object | Yes | Provide the length of the item in ready to use condition. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side in ready to condition. |

#### item_length_width_height[].height

Provide the measurement of the height measured from floor to top of the item in a ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the height measured from floor to top of the item in a ready to use condition. |
| `unit` | string | Yes | Select the unit of measure for item height. |

#### item_length_width_height[].length

Provide the length of the item in ready to use condition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length of the item in ready to use condition. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of movement that the base of the furniture allows for. Base movement represents how the base enables the furniture to spin or move vertically or horizontally. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the metal used for decorative coating on the table's surface, enhancing appearance and protecting against corrosion or wear. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `depth` | object | Yes | Provide the measurement of the item from front to back in an assembled state. If there is no front, depth is the shorter edge. |
...
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the measurement from side to side of the front of the item in an assembled state. If there is no side, width is the longer edge. |

#### item_depth_width_height[].depth

Provide the measurement of the item from front to back in an assembled state. If there is no front, depth is the shorter edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement of the item from front to back in an assembled state. If there is no front, depth is the shorter edge. |
...
Provide the measurement from side to side of the front of the item in an assembled state. If there is no side, width is the longer edge.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the measurement from side to side of the front of the item in an assembled state. If there is no side, width is the longer edge. |
| `unit` | string | Yes | Select the unit of measure for item width. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item in ready to use condition. |
| `unit` | string | Yes | Provide the unit of measure used to measure the item's width. |
| `marketplace_id` | object | No |  |
...
| `unit` | string | Yes | Provide the corresponding unit used to designate the table's clearance from the ground. |
| `marketplace_id` | object | No |  |
...
**Title:** Table Extension Mechanism
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the extension mechanism utilized by this table. A table extension mechanism represents the system used to expand a table's size. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
**Title:** Collapsed Length Minimum
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the minimum length measurement of the item without any extensions. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the table's minimum collapsed length. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the types of imperfections and unique characteristics found in the natural material of the table, contributing to its individuality. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
**Title:** Unextended Seating Capacity
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of people the item can seat when in its unextended form. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the diameter of the item's umbrella hole. An umbrella hole is designed to hold an umbrella for shade or decoration. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the diameter of the table's umbrella hole. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the distance from the top of the base to the underside of the top surface of the item. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's base to top distance. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the number of benches included with the item. Benches are long seats on which multiple people may sit on at the same time. |
| `marketplace_id` | object | No |  |
