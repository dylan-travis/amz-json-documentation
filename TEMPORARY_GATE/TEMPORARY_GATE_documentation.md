# TEMPORARY_GATE Schema Documentation
...
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the intended users based on safety and developmental considerations. |
...
| `mounting_type` | array | Provide the way the item is installed or secured in place, whether hardware mounted or tension held. |
| `item_form` | array | Provide a value that represents the form of the item |
| `unit_count` | array | Provide the total number of units that make up the item, indicating its size or capacity. |
...
| `team_name` | array | Provide the name of the sports team associated with the temporary gate, indicating the branded design or theme of the product. |
...
Provide the age range the item is suitable for, indicating the intended users based on safety and developmental considerations.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the age range for which the temporary gate is intended or appropriate, helping customers choose suitable safety barriers. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the item is installed or secured in place, whether hardware mounted or tension held.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the method by which the temporary gate is attached or secured in place, such as pressure-mounted or hardware-mounted. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the total number of units that make up the item, indicating its size or capacity.
...
Provide the name of the sports team associated with the temporary gate, indicating the branded design or theme of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the temporary gate, indicating the branded design or theme of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width of the item from side to side when placed in the manner in which it is expected to be used. |
...
Provide the width of the item from side to side when placed in the manner in which it is expected to be used.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width of the item from side to side when placed in the manner in which it is expected to be used. |
