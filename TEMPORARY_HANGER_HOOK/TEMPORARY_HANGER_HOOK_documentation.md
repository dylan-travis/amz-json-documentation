# TEMPORARY_HANGER_HOOK Schema Documentation
...
| `style` | array | Provide the aesthetic design of the storage hook, describing its visual appearance and decorative elements. |
...
| `mounting_type` | array | Provide the way the temporary hanger hook attaches to a surface, indicating how it secures itself without permanent installation. |
...
| `maximum_weight_recommendation` | array | Provide the maximum weight the item can safely hold, the highest load it can bear without failing or damaging surfaces. |
...
Provide the aesthetic design of the storage hook, describing its visual appearance and decorative elements.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the aesthetic design of the storage hook, describing its visual appearance and decorative elements. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the way the temporary hanger hook attaches to a surface, indicating how it secures itself without permanent installation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the way the temporary hanger hook attaches to a surface, indicating how it secures itself without permanent installation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum weight the item can safely hold, the highest load it can bear without failing or damaging surfaces.
