# TOYS_AND_GAMES Schema Documentation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended age range for the toy or game, indicating the appropriate user group for the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy or game, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the learning or developmental goal that the toy or game is designed to help achieve. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `description` | array | No | Provide the type of battery the item uses or requires, explaining its purpose and how it powers the toy or game. |
