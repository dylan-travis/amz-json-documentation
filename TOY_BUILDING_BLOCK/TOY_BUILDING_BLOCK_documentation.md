# TOY_BUILDING_BLOCK Schema Documentation
...
| `compliance_building_block_shape[item].value` | Required in compliance_building_block_shape[item] object |
...
| `toy_building_block_type[item].value` | Required in toy_building_block_type[item] object |
...
- `toy_building_block_type.value` - Required when `toy_building_block_type` is provided
...
- `compliance_building_block_shape.value` - Required when `compliance_building_block_shape` is provided
...
| `age_range_description` | array | Provide the recommended ages for using the item, explaining the appropriate age range for safe and engaging play. |
...
| `subject_character` | array | Provide the character or theme the item represents, depicting a popular figure, story, or concept. |
...
| `sub_brand` | array | Provide the secondary brand information related to the toy building blocks, such as licensed or franchise themes. |
...
| `customer_package_type` | array | Provide the packaging the item comes in, such as a box, bag, or container, intended for customers to purchase. |
...
| `team_name` | array | Provide the name of the sports team associated with the toy building block set, representing a specific team from a sports league. |
| `scent` | array | Provide a description of the scent of the item |
| `educational_objective` | array | Provide the learning goal or skill the item aims to develop, such as problem-solving, creativity, or hand-eye coordination. |
...
| `toy_building_block_type` | array | Provide the specific type of toy building block. This is primarily defined by the manner in which the blocks fit together. |
...
| `compliance_building_block_shape` | array | Provide the shape of the item, for compliance purposes. |
...
- `Toy interlocking building sets`
...
Provide the recommended ages for using the item, explaining the appropriate age range for safe and engaging play.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for the toy building blocks, indicating the intended or appropriate user group for the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the character or theme the item represents, depicting a popular figure, story, or concept.
...
Provide the secondary brand information related to the toy building blocks, such as licensed or franchise themes.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy building blocks, such as licensed or franchise themes. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the packaging the item comes in, such as a box, bag, or container, intended for customers to purchase.
...
Provide the name of the sports team associated with the toy building block set, representing a specific team from a sports league.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the toy building block set, representing a specific team from a sports league. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the learning goal or skill the item aims to develop, such as problem-solving, creativity, or hand-eye coordination.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the learning or developmental goal that the building block toy is designed to help achieve. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
### toy_building_block_type

Provide the specific type of toy building block. This is primarily defined by the manner in which the blocks fit together.

**Type:** array

**Title:** Toy Building Block Type
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific type of toy building block. This is primarily defined by the manner in which the blocks fit together. |
| `marketplace_id` | object | No |  |
...
### compliance_building_block_shape

Provide the shape of the item, for compliance purposes.

**Type:** array

**Title:** Compliance - Building Block Shape
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the shape of the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
