...
| `compliance_toy_filling[item].value` | Required in compliance_toy_filling[item] object |
| `compliance_toy_height[item].value` | Required in compliance_toy_height[item] object |
| `compliance_toy_material[item].value` | Required in compliance_toy_material[item] object |
| `compliance_toy_representation[item].value` | Required in compliance_toy_representation[item] object |
...
| `hair_type[item].language_tag` | Required in hair_type[item] object |
| `hair_type[item].value` | Required in hair_type[item] object |
...
| `initial_character[item].value` | Required in initial_character[item] object |
...
| `play_activity_location[item].value` | Required in play_activity_location[item] object |
...
| `toy_figure_type[item].value` | Required in toy_figure_type[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the intended age range for the toy figure, indicating the appropriate age group for safe and enjoyable play. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the toy figure, indicating the primary persona or entity depicted in the item's design. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event the toy figure is designed for, such as cultural, national, or religious celebrations. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Enter the alphabetic character that is part of the design of the item |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy figure, such as licensed or franchise details. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the toy figure, representing the team affiliation of the character or player depicted. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the most suitable hair type for the toy figure, indicating the texture or style of hair on the figure. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of toy figure. Toy figure types are groupings of toy figure products based on common feel, features and functionality. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the primary location where the toy figure is meant to be played with or used, based on its design or size. |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the material used to make the inner part of the item, the core or stuffing inside the outer covering. |
...
**Title:** Compliance - Toy Representation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the representation of the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the height dimension of the toy in centimeters, for compliance purposes. |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the material used as filling for the item, for compliance purposes. |
| `marketplace_id` | object | No |  |
