# TOY_FIGURE_PLAYSET Schema Documentation
...
| `subject_character` | array | Provide the main character represented by the toy figure or playset, indicating the primary focus of the item. |
...
| `sub_brand` | array | Provide the secondary brand information related to the toy figure playset, such as licensed or franchise names associated with the product. |
...
| `team_name` | array | Provide the team name associated with the toy figure playset, representing the sports team featured in the product. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the suitable age range for the toy figure playset, indicating the intended or appropriate ages for use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the main character represented by the toy figure or playset, indicating the primary focus of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the toy figure or playset, indicating the primary focus of the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand information related to the toy figure playset, such as licensed or franchise names associated with the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy figure playset, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the team name associated with the toy figure playset, representing the sports team featured in the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the team name associated with the toy figure playset, representing the sports team featured in the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
