...
| `maximum_range[item].unit` | Required in maximum_range[item] object |
| `maximum_range[item].value` | Required in maximum_range[item] object |
...
| `toy_gun_type[item].value` | Required in toy_gun_type[item] object |
...
- `maximum_range.value` - Required when `maximum_range` is provided
- `maximum_range.unit` - Required when `maximum_range` is provided
...
- `toy_gun_type.value` - Required when `toy_gun_type` is provided
...
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the appropriate ages for safe and intended use. |
...
| `occasion_type` | array | Provide the type of occasion or event the item is suitable for, like parties, holidays, or playtime. |
...
| `sub_brand` | array | Provide the secondary brand information related to the toy gun, such as licensed or franchise names associated with the product. |
...
| `maximum_range` | array | Provide the maximum range of operation the product supports |
...
| `team_name` | array | Provide the name of the sports team associated with the toy gun, representing the product's themed design or branding. |
| `item_length_width_height` | array | Provide the length, width and height of the item in ready to use condition. |
| `toy_gun_type` | array | Provide the specific type of toy gun. Toy gun types are primarily defined by the type of projectile the gun releases. |
...
Provide the age range the item is suitable for, indicating the appropriate ages for safe and intended use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the recommended age range for using the toy gun, indicating the appropriate user group for safe and enjoyable play. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the type of occasion or event the item is suitable for, like parties, holidays, or playtime.
...
Provide the secondary brand information related to the toy gun, such as licensed or franchise names associated with the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy gun, such as licensed or franchise names associated with the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the maximum range of operation the product supports
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the maximum range of operation the product supports |
| `unit` | string | Yes | Provide the corresponding unit used to designate the toy gun's maximum shooting distance. |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the toy gun, representing the product's themed design or branding.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the toy gun, representing the product's themed design or branding. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the specific type of toy gun. Toy gun types are primarily defined by the type of projectile the gun releases.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the specific type of toy gun. Toy gun types are primarily defined by the type of projectile the gun releases. |
| `marketplace_id` | object | No |  |
