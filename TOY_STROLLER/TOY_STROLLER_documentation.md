# TOY_STROLLER Schema Documentation
...
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the appropriate ages for safe and engaging use. |
...
| `team_name` | array | Provide the name of the sports team associated with the toy stroller, indicating the branded or themed design of the product. |
...
Provide the age range the item is suitable for, indicating the appropriate ages for safe and engaging use.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the recommended age range for children to use this toy stroller, indicating its suitability for different stages of childhood play. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy stroller, such as licensed or franchise details. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the name of the sports team associated with the toy stroller, indicating the branded or themed design of the product.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the toy stroller, indicating the branded or themed design of the product. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
