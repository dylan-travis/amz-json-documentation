# TOY_VEHICLE_SET Schema Documentation
...
| `battery[item].cell_composition_other_than_listed[item].value` | Required in battery[item].cell_composition_other_than_listed[item] object |
| `battery[item].description[item].language_tag` | Required in battery[item].description[item] object |
| `battery[item].description[item].language_tag` | Required in battery[item].description[item] object |
| `battery[item].description[item].value` | Required in battery[item].description[item] object |
| `battery[item].description[item].value` | Required in battery[item].description[item] object |
...
| `compatibility_options[item].language_tag` | Required in compatibility_options[item] object |
| `compatibility_options[item].value` | Required in compatibility_options[item] object |
...
| `control_method[item].value` | Required in control_method[item] object |
| `control_type[item].language_tag` | Required in control_type[item] object |
| `control_type[item].value` | Required in control_type[item] object |
| `controller_type[item].language_tag` | Required in controller_type[item] object |
| `controller_type[item].value` | Required in controller_type[item] object |
| `country_as_labeled[item].value` | Required in country_as_labeled[item] object |
...
| `design_name[item].language_tag` | Required in design_name[item] object |
| `design_name[item].value` | Required in design_name[item] object |
...
| `educational_objective[item].language_tag` | Required in educational_objective[item] object |
| `educational_objective[item].value` | Required in educational_objective[item] object |
...
| `fit_type[item].language_tag` | Required in fit_type[item] object |
| `fit_type[item].value` | Required in fit_type[item] object |
...
| `includes_rechargable_battery[item].value` | Required in includes_rechargable_battery[item] object |
| `includes_remote[item].value` | Required in includes_remote[item] object |
| `inner[item].material[item].language_tag` | Required in inner[item].material[item] object |
| `inner[item].material[item].language_tag` | Required in inner[item].material[item] object |
| `inner[item].material[item].value` | Required in inner[item].material[item] object |
| `inner[item].material[item].value` | Required in inner[item].material[item] object |
...
| `manufacturer_maximum_age[item].value` | Required in manufacturer_maximum_age[item] object |
...
| `mfg_warranty_description_parts[item].language_tag` | Required in mfg_warranty_description_parts[item] object |
| `mfg_warranty_description_parts[item].value` | Required in mfg_warranty_description_parts[item] object |
| `minimum_age[item].value` | Required in minimum_age[item] object |
...
| `model_year[item].value` | Required in model_year[item] object |
...
| `not_for_kids[item].value` | Required in not_for_kids[item] object |
...
| `power_plug_type[item].value` | Required in power_plug_type[item] object |
...
| `purchasable_offer[item].quantity_discount_plan[item].schedule[item].levels[item].value` | Required in purchasable_offer[item].quantity_discount_plan[item].schedule[item].levels[item] object |
| `purchasable_offer[item].quantity_discount_plan[item].schedule[item].levels[item].value` | Required in purchasable_offer[item].quantity_discount_plan[item].schedule[item].levels[item] object |
| `rail_gauge[item].language_tag` | Required in rail_gauge[item] object |
| `rail_gauge[item].value` | Required in rail_gauge[item] object |
...
| `remote_control_technology[item].language_tag` | Required in remote_control_technology[item] object |
| `remote_control_technology[item].value` | Required in remote_control_technology[item] object |
...
| `scale_name[item].language_tag` | Required in scale_name[item] object |
| `scale_name[item].value` | Required in scale_name[item] object |
...
| `sub_brand[item].language_tag` | Required in sub_brand[item] object |
| `sub_brand[item].value` | Required in sub_brand[item] object |
...
| `top_style[item].language_tag` | Required in top_style[item] object |
| `top_style[item].value` | Required in top_style[item] object |
...
- `model_year.value` - Required when `model_year` is provided
...
- `compatibility_options.value` - Required when `compatibility_options` is provided
- `compatibility_options.language_tag` - Required when `compatibility_options` is provided
...
- `power_plug_type.value` - Required when `power_plug_type` is provided
...
- `includes_remote.value` - Required when `includes_remote` is provided
- `remote_control_technology.value` - Required when `remote_control_technology` is provided
- `remote_control_technology.language_tag` - Required when `remote_control_technology` is provided
- `scale_name.value` - Required when `scale_name` is provided
- `scale_name.language_tag` - Required when `scale_name` is provided
...
- `rail_gauge.value` - Required when `rail_gauge` is provided
- `rail_gauge.language_tag` - Required when `rail_gauge` is provided
...
- `minimum_age.value` - Required when `minimum_age` is provided
- `not_for_kids.value` - Required when `not_for_kids` is provided
...
- `mfg_warranty_description_parts.value` - Required when `mfg_warranty_description_parts` is provided
- `mfg_warranty_description_parts.language_tag` - Required when `mfg_warranty_description_parts` is provided
...
| `model_year` | array | Provide the model year or year of production of the item. |
...
| `special_feature` | array | Provide the unique characteristics that set this toy vehicle set apart from similar products. |
| `style` | array | Provide the aesthetic design or visual theme of the toy vehicle set, describing its distinctive appearance or representation. |
| `target_gender` | array | Provide the target gender for the product |
| `age_range_description` | array | Provide the age range the item is suitable for, indicating the appropriate ages for safe and engaging play. |
...
| `control_type` | array | Provide the method used to operate or control the item, such as remote control, manual, or self-propelled. |
...
| `occasion_type` | array | Provide the holiday or major life event that the toy vehicle set is designed for, such as a specific celebration or milestone. |
...
| `sub_brand` | array | Provide the secondary brand or franchise associated with the item, such as licensed characters or themes. |
...
| `compatibility_options` | array | Provide the compatibility options for the toy vehicle set, indicating what other products or sets it can be used with. |
...
| `power_plug_type` | array | Provide the type of electrical connector used to power or charge the toy vehicle set or its components. |
...
| `controller_type` | array | Provide the type of controller included with or built into the toy vehicle set, indicating how the set is operated or controlled. |
...
| `includes_remote` | array | Indicate whether or not the product includes a remote |
| `remote_control_technology` | array | Describes the technology used for the remote control |
| `scale_name` | array | Provide the name indicating the size ratio of the toy vehicles compared to their real-life counterparts in the set. |
...
| `rail_gauge` | array | Provide the size of the track used in the miniature train set, indicating the scale and compatibility of the toy vehicles. |
| `educational_objective` | array | Provide the learning goal or skill the item aims to develop, like knowledge, motor skills, or problem-solving. |
| `base` | array | Enter the specifications for the base |
| `is_electric` | array | Item is powered by electricity |
| `minimum_age` | array | Your age recommendation in months |
| `not_for_kids` | array | Provide whether the item is unsuitable for children to use or play with, made for older audiences. |
| `top_style` | array | Provide the design or appearance of the top part of the toy vehicle or set component, describing its visual characteristics. |
| `maximum_weight_recommendation` | array | Provide the highest weight the item can handle without issues, the maximum load it can support. |
| `control_method` | array | Provide the way the item is operated, like using an app or physical controls, to control its functions. |
...
| `mfg_warranty_description_parts` | array | Provide the details on the manufacturer's warranty coverage for parts of the item, terms and conditions for repair or replacement. |
...
| `includes_rechargable_battery` | array | Indicate whether the product includes rechargable batteries |
...
Provide the model year or year of production of the item.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | integer | Yes | Provide the model year or year of production of the item. |
| `marketplace_id` | object | No |  |
...
Provide the unique characteristics that set this toy vehicle set apart from similar products.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the unique characteristics that set this toy vehicle set apart from similar products. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### style

Provide the aesthetic design or visual theme of the toy vehicle set, describing its distinctive appearance or representation.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the aesthetic design or visual theme of the toy vehicle set, describing its distinctive appearance or representation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the age range the item is suitable for, indicating the appropriate ages for safe and engaging play.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the recommended age range for the toy vehicle set, indicating the appropriate developmental stage for safe and enjoyable use. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the method used to operate or control the item, such as remote control, manual, or self-propelled.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Indicates the control that the user has on the device. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the holiday or major life event that the toy vehicle set is designed for, such as a specific celebration or milestone.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the holiday or major life event that the toy vehicle set is designed for, such as a specific celebration or milestone. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the secondary brand or franchise associated with the item, such as licensed characters or themes.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the secondary brand information related to the toy vehicle set, such as licensed or franchise details. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the item's fit type |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the compatibility options for the toy vehicle set, indicating what other products or sets it can be used with.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the compatibility options for the toy vehicle set, indicating what other products or sets it can be used with. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select a value that best describes the design on the product |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the type of electrical connector used to power or charge the toy vehicle set or its components.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of electrical connector used to power or charge the toy vehicle set or its components. |
| `marketplace_id` | object | No |  |
...
Provide the type of controller included with or built into the toy vehicle set, indicating how the set is operated or controlled.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the type of controller included with or built into the toy vehicle set, indicating how the set is operated or controlled. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
**Title:** Manufacturer Maximum Age (MONTHS)
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the recommended maximum age for the product in months |
| `marketplace_id` | object | No |  |
...
Indicate whether or not the product includes a remote
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Indicate whether or not the product includes a remote |
| `marketplace_id` | object | No |  |

### remote_control_technology

Describes the technology used for the remote control
...
- `Cable, Cable/infrared, Infrared, Infrared/radio, Radio`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Specify the technology used for the remote control |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### scale_name

Provide the name indicating the size ratio of the toy vehicles compared to their real-life counterparts in the set.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name indicating the size ratio of the toy vehicles compared to their real-life counterparts in the set. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
Provide the size of the track used in the miniature train set, indicating the scale and compatibility of the toy vehicles.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the size of the track used in the miniature train set, indicating the scale and compatibility of the toy vehicles. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### educational_objective

Provide the learning goal or skill the item aims to develop, like knowledge, motor skills, or problem-solving.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the learning or developmental goal that the toy vehicle set is designed to help achieve. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Describe the material of the item's base |
...
Your age recommendation in months

**Type:** array

**Title:** Minimum Age Recomendation
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Your age recommendation in months |
| `marketplace_id` | object | No |  |

### not_for_kids

Provide whether the item is unsuitable for children to use or play with, made for older audiences.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | This attribute indicates if the product is made for kids |
| `marketplace_id` | object | No |  |

### top_style

Provide the design or appearance of the top part of the toy vehicle or set component, describing its visual characteristics.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the design or appearance of the top part of the toy vehicle or set component, describing its visual characteristics. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |

### maximum_weight_recommendation

Provide the highest weight the item can handle without issues, the maximum load it can support.
...
Provide the way the item is operated, like using an app or physical controls, to control its functions.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the mechanism used to control the toy vehicles or set components for standard operations, such as movement or interaction. |
| `marketplace_id` | object | No |  |
...
| `description` | array | No | Provide the details about the battery used to power the item, its type, capacity, and how it is recharged or replaced. |
...
Provide the details on the manufacturer's warranty coverage for parts of the item, terms and conditions for repair or replacement.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | What is the length of the warranty for the lamp in the projector? |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Select the country that is listed on the product's label |
| `marketplace_id` | object | No |  |
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `material` | array | No | Specify the inner material of the product |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | boolean | Yes | Indicate whether the product includes rechargable batteries |
| `marketplace_id` | object | No |  |
