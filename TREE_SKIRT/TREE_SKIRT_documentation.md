# TREE_SKIRT Schema Documentation
...
| `fabric_type` | array | Provide the materials used in the tree skirt, listing all fabrics with their percentage composition. |
...
| `team_name` | array | Provide the name of the sports team associated with the tree skirt, representing the team's branding on the decorative fabric. |
...
Provide the materials used in the tree skirt, listing all fabrics with their percentage composition.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials used in the tree skirt, listing all fabrics with their percentage composition. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| `marketplace_id` | object | No |  |
| `string_value` | string | No | Provide the item diameter |
...
Provide the name of the sports team associated with the tree skirt, representing the team's branding on the decorative fabric.
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the tree skirt, representing the team's branding on the decorative fabric. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
