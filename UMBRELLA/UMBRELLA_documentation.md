...
| `canopy[item].diameter[item].unit` | Required in canopy[item].diameter[item] object |
| `canopy[item].diameter[item].unit` | Required in canopy[item].diameter[item] object |
| `canopy[item].diameter[item].value` | Required in canopy[item].diameter[item] object |
| `canopy[item].diameter[item].value` | Required in canopy[item].diameter[item] object |
| `canopy[item].material[item].language_tag` | Required in canopy[item].material[item] object |
| `canopy[item].material[item].language_tag` | Required in canopy[item].material[item] object |
| `canopy[item].material[item].value` | Required in canopy[item].material[item] object |
| `canopy[item].material[item].value` | Required in canopy[item].material[item] object |
...
| `umbrella_tilt_mechanism[item].value` | Required in umbrella_tilt_mechanism[item] object |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the materials used in the umbrella's canopy, listing fabric types and their percentage composition. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the main character represented by the umbrella, indicating the fictional or popular figure depicted on or associated with the item. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the name of the sports team associated with the umbrella, indicating the specific team branding or affiliation. |
| `language_tag` | object | Yes |  |
| `marketplace_id` | object | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `diameter` | array | No | Provide the diameter of the canopy. For canopies supported by ribs, this is measured from the tip of one rib directly to the tip of the opposing rib. |
| `marketplace_id` | object | No |  |
| `material` | array | No | Provide the materials from which the canopy of the product is made. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | string | Yes | Provide the mechanism that changes the angle of the umbrella canopy, allowing adjustment for better sun or rain protection. |
| `marketplace_id` | object | No |  |
