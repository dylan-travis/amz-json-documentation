# UTILITY_CART_WAGON Schema Documentation
...
| `caster[item].type[item].language_tag` | Required in caster[item].type[item] object |
| `caster[item].type[item].language_tag` | Required in caster[item].type[item] object |
| `caster[item].type[item].value` | Required in caster[item].type[item] object |
| `caster[item].type[item].value` | Required in caster[item].type[item] object |
...
| `folded_item_length_width_height[item].height` | Required in folded_item_length_width_height[item] object |
| `folded_item_length_width_height[item].height.unit` | Required in folded_item_length_width_height[item].height object |
| `folded_item_length_width_height[item].height.unit` | Required in folded_item_length_width_height[item].height object |
| `folded_item_length_width_height[item].height.value` | Required in folded_item_length_width_height[item].height object |
| `folded_item_length_width_height[item].height.value` | Required in folded_item_length_width_height[item].height object |
| `folded_item_length_width_height[item].length` | Required in folded_item_length_width_height[item] object |
| `folded_item_length_width_height[item].length.unit` | Required in folded_item_length_width_height[item].length object |
| `folded_item_length_width_height[item].length.unit` | Required in folded_item_length_width_height[item].length object |
| `folded_item_length_width_height[item].length.value` | Required in folded_item_length_width_height[item].length object |
| `folded_item_length_width_height[item].length.value` | Required in folded_item_length_width_height[item].length object |
| `folded_item_length_width_height[item].width` | Required in folded_item_length_width_height[item] object |
| `folded_item_length_width_height[item].width.unit` | Required in folded_item_length_width_height[item].width object |
| `folded_item_length_width_height[item].width.unit` | Required in folded_item_length_width_height[item].width object |
| `folded_item_length_width_height[item].width.value` | Required in folded_item_length_width_height[item].width object |
| `folded_item_length_width_height[item].width.value` | Required in folded_item_length_width_height[item].width object |
...
| `tire[item].tire_type[item].language_tag` | Required in tire[item].tire_type[item] object |
| `tire[item].tire_type[item].language_tag` | Required in tire[item].tire_type[item] object |
| `tire[item].tire_type[item].value` | Required in tire[item].tire_type[item] object |
| `tire[item].tire_type[item].value` | Required in tire[item].tire_type[item] object |
...
| `weight_capacity[item].maximum[item].value` | Required in weight_capacity[item].maximum[item] object |
| `wheel[item].diameter[item].unit` | Required in wheel[item].diameter[item] object |
| `wheel[item].diameter[item].unit` | Required in wheel[item].diameter[item] object |
...
- `folded_item_length_width_height.height` - Required when `folded_item_length_width_height` is provided
- `folded_item_length_width_height.length` - Required when `folded_item_length_width_height` is provided
- `folded_item_length_width_height.width` - Required when `folded_item_length_width_height` is provided
...
| `tire` | array | The attribute indicates Tire of the product |
...
| `caster` | array | The attribute indicates Caster of the product |
...
| `item_depth_width_height` | array | Provide the length, width and height of the item when fully set up for use, like a rug rolled out. |
| `folded_item_length_width_height` | array | Provide the length, width and height dimensions of the item when folded into a compact state. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `diameter` | array | No | Provide the diameter measurement of the wheel component |
| `marketplace_id` | object | No |  |
...
The attribute indicates Tire of the product
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `tire_type` | array | No | Enter the tire type for the vehicle |
| `marketplace_id` | object | No |  |
...
The attribute indicates Caster of the product
...
|----------|------|----------|-------------|
| `marketplace_id` | object | No |  |
| `type` | array | No | Provide the type of wheels the item has, such as swiveling or fixed, for easy movement and maneuverability. |
...
Provide the length, width and height of the item when fully set up for use, like a rug rolled out.
...
### folded_item_length_width_height

Provide the length, width and height dimensions of the item when folded into a compact state.

**Type:** array

**Title:** Folded Item Length Width Height

**Required:** No

**Examples:**

- `29.5 inches x 20.2 inches x 8.0 inches`
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `height` | object | Yes | Provide the height dimensions of the item when folded into a compact state. |
| `length` | object | Yes | Provide the length dimensions of the item when folded into a compact state. |
| `marketplace_id` | object | No |  |
| `width` | object | Yes | Provide the width dimensions of the item when folded into a compact state. |

#### folded_item_length_width_height[].height

Provide the height dimensions of the item when folded into a compact state.

**Type:** object

**Title:** Folded Height Dimension
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the height dimensions of the item when folded into a compact state. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's height when completely folded. |

#### folded_item_length_width_height[].length

Provide the length dimensions of the item when folded into a compact state.

**Type:** object

**Title:** Folded Length Dimension
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the length dimensions of the item when folded into a compact state. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's length when completely folded. |

#### folded_item_length_width_height[].width

Provide the width dimensions of the item when folded into a compact state.

**Type:** object

**Title:** Folded Width Dimension
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `value` | number | Yes | Provide the width dimensions of the item when folded into a compact state. |
| `unit` | string | Yes | Provide the corresponding unit used to designate the item's width when completely folded. |
